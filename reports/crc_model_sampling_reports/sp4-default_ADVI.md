...
```
    ...
    Pareto k diagnostic values:
                             Count   Pct.
    (-Inf, 0.5]   (good)      306   21.2%
     (0.5, 0.7]   (ok)        228   15.8%
       (0.7, 1]   (bad)       360   24.9%
       (1, Inf)   (very bad)  549   38.0%
