...
```
    ...
    Pareto k diagnostic values:
                             Count   Pct.
    (-Inf, 0.5]   (good)     1082   75.0%
     (0.5, 0.7]   (ok)        286   19.8%
       (0.7, 1]   (bad)        68    4.7%
       (1, Inf)   (very bad)    7    0.5%
