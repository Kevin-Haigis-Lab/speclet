...
![svg](simple-default_MCMC_files/simple-default_MCMC_15_0.svg)
...
```
    ...
    BFMI: 1.151, 1.371, 1.108, 1.176
    avg. step size: 1.629, 1.223, 0.948, 1.011

![png](simple-default_MCMC_files/simple-default_MCMC_17_1.png)
...
![png](simple-default_MCMC_files/simple-default_MCMC_20_0.png)

    <ggplot: (8781891769405)>

![png](simple-default_MCMC_files/simple-default_MCMC_20_2.png)

    <ggplot: (8781891808485)>
...
![png](simple-default_MCMC_files/simple-default_MCMC_24_0.png)
...
```
    ...
    Computed from 4000 by 570 log-likelihood matrix

             Estimate       SE
    elpd_loo  -588.60    24.92
    p_loo        3.26        -
    ------
...
![png](simple-default_MCMC_files/simple-default_MCMC_26_2.png)
...
![png](simple-default_MCMC_files/simple-default_MCMC_28_0.png)

    <ggplot: (8781891641625)>
...
![png](simple-default_MCMC_files/simple-default_MCMC_29_0.png)

    <ggplot: (8781891002763)>
...
![png](simple-default_MCMC_files/simple-default_MCMC_30_0.png)

    <ggplot: (8781891722427)>
...
![png](simple-default_MCMC_files/simple-default_MCMC_31_0.png)

    <ggplot: (8781891002640)>
...
![png](simple-default_MCMC_files/simple-default_MCMC_32_0.png)

    <ggplot: (8781890949024)>
...
![png](simple-default_MCMC_files/simple-default_MCMC_33_0.png)

    <ggplot: (8781891005754)>
...
![png](simple-default_MCMC_files/simple-default_MCMC_34_0.png)

    <ggplot: (8781890652543)>
...
![png](simple-default_MCMC_files/simple-default_MCMC_35_0.png)

    <ggplot: (8781890608011)>
...
![png](simple-default_MCMC_files/simple-default_MCMC_36_0.png)

    <ggplot: (8781890865565)>
