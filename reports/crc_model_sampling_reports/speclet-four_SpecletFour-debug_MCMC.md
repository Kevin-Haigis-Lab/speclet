...
<pre style="white-space:pre;overflow-x:auto;line-height:normal;font-family:Menlo,'DejaVu Sans Mono',consolas,'Courier New',monospace"><span style="color: #7fbfbf; text-decoration-color: #7fbfbf">[05/25/21 12:15:27] </span><span style="color: #000080; text-decoration-color: #000080">INFO    </span> Cache directory: <span style="color: #800080; text-decoration-color: #800080">/n/data1/hms/db</span> <a href="file:///n/data1/hms/dbmi/park/Cook/speclet/src/command_line_interfaces/sampling_pymc3_models_cli.py"><span style="color: #7f7f7f; text-decoration-color: #7f7f7f">sampling_pymc3_models_cli.py</span></a><span style="color: #7f7f7f; text-decoration-color: #7f7f7f">:87</span>
...
<pre style="white-space:pre;overflow-x:auto;line-height:normal;font-family:Menlo,'DejaVu Sans Mono',consolas,'Courier New',monospace"><span style="color: #7fbfbf; text-decoration-color: #7fbfbf">                    </span><span style="color: #000080; text-decoration-color: #000080">INFO    </span> Sampling <span style="color: #008000; text-decoration-color: #008000">'speclet-four'</span> with     <a href="file:///n/data1/hms/dbmi/park/Cook/speclet/src/command_line_interfaces/sampling_pymc3_models_cli.py"><span style="color: #7f7f7f; text-decoration-color: #7f7f7f">sampling_pymc3_models_cli.py</span></a><span style="color: #7f7f7f; text-decoration-color: #7f7f7f">:94</span>
                             custom name <span style="color: #008000; text-decoration-color: #008000">'SpecletFour-debug'</span>
</pre>
...
<pre style="white-space:pre;overflow-x:auto;line-height:normal;font-family:Menlo,'DejaVu Sans Mono',consolas,'Courier New',monospace"><span style="color: #7fbfbf; text-decoration-color: #7fbfbf">                    </span><span style="color: #000080; text-decoration-color: #000080">INFO    </span> finished; execution time: <span style="color: #008080; text-decoration-color: #008080; font-weight: bold">0.48</span>  <a href="file:///n/data1/hms/dbmi/park/Cook/speclet/src/command_line_interfaces/sampling_pymc3_models_cli.py"><span style="color: #7f7f7f; text-decoration-color: #7f7f7f">sampling_pymc3_models_cli.py</span></a><span style="color: #7f7f7f; text-decoration-color: #7f7f7f">:134</span>
                             minutes
</pre>
...
![svg](speclet-four_SpecletFour-debug_MCMC_files/speclet-four_SpecletFour-debug_MCMC_13_0.svg)
...
```
    ...
    R-HAT
    <xarray.Dataset>
    Dimensions:    (b_dim_0: 2, g_dim_0: 99, g_dim_1: 36, h_dim_0: 99, μ_dim_0: 34408, μ_g_dim_0: 5, σ_dim_0: 391)
    Coordinates:
      * h_dim_0    (h_dim_0) int64 0 1 2 3 4 5 6 7 8 ... 90 91 92 93 94 95 96 97 98
      * μ_g_dim_0  (μ_g_dim_0) int64 0 1 2 3 4
      * g_dim_0    (g_dim_0) int64 0 1 2 3 4 5 6 7 8 ... 90 91 92 93 94 95 96 97 98
      * g_dim_1    (g_dim_1) int64 0 1 2 3 4 5 6 7 8 ... 27 28 29 30 31 32 33 34 35
      * b_dim_0    (b_dim_0) int64 0 1
      * μ_dim_0    (μ_dim_0) int64 0 1 2 3 4 5 ... 34403 34404 34405 34406 34407
      * σ_dim_0    (σ_dim_0) int64 0 1 2 3 4 5 6 7 ... 384 385 386 387 388 389 390
    Data variables: (12/14)
        μ_h        float64 1.178
        h          (h_dim_0) float64 1.175 1.176 1.17 1.177 ... 1.174 1.175 1.175
        μ_μ_g      float64 1.562
        μ_g        (μ_g_dim_0) float64 1.588 1.591 1.589 1.58 1.584
        g          (g_dim_0, g_dim_1) float64 1.269 1.299 1.305 ... 1.237 1.244
        μ_b        float64 1.038
        ...         ...
        σ_μ_g      float64 1.0
        σ_g        float64 1.001
        σ_b        float64 1.003
        μ          (μ_dim_0) float64 0.9999 0.9999 1.0 1.0 ... 0.9999 0.9999 0.9999
        σ_σ        float64 1.0
        σ          (σ_dim_0) float64 1.0 1.0 0.9999 1.0 ... 0.9999 1.0 0.9999 1.0
    ============================================================
    BFMI
    [0.83002402 0.85603683 0.83002402 0.85603683]
...
![png](speclet-four_SpecletFour-debug_MCMC_files/speclet-four_SpecletFour-debug_MCMC_18_0.png)

    <ggplot: (2996086977431)>

![png](speclet-four_SpecletFour-debug_MCMC_files/speclet-four_SpecletFour-debug_MCMC_18_2.png)

    <ggplot: (2996086927671)>

![png](speclet-four_SpecletFour-debug_MCMC_files/speclet-four_SpecletFour-debug_MCMC_18_4.png)

    <ggplot: (2996086931294)>

![png](speclet-four_SpecletFour-debug_MCMC_files/speclet-four_SpecletFour-debug_MCMC_18_6.png)

    <ggplot: (2996086979341)>

![png](speclet-four_SpecletFour-debug_MCMC_files/speclet-four_SpecletFour-debug_MCMC_18_8.png)

    <ggplot: (2996086931950)>

![png](speclet-four_SpecletFour-debug_MCMC_files/speclet-four_SpecletFour-debug_MCMC_18_10.png)

    <ggplot: (2996110145558)>

![png](speclet-four_SpecletFour-debug_MCMC_files/speclet-four_SpecletFour-debug_MCMC_18_12.png)

    <ggplot: (2996086931950)>

![png](speclet-four_SpecletFour-debug_MCMC_files/speclet-four_SpecletFour-debug_MCMC_18_14.png)

    <ggplot: (2996110135965)>

![png](speclet-four_SpecletFour-debug_MCMC_files/speclet-four_SpecletFour-debug_MCMC_18_16.png)

    <ggplot: (2996086931119)>

![png](speclet-four_SpecletFour-debug_MCMC_files/speclet-four_SpecletFour-debug_MCMC_18_18.png)

    <ggplot: (2996091295052)>

![png](speclet-four_SpecletFour-debug_MCMC_files/speclet-four_SpecletFour-debug_MCMC_18_20.png)

    <ggplot: (2996089932427)>

![png](speclet-four_SpecletFour-debug_MCMC_files/speclet-four_SpecletFour-debug_MCMC_18_22.png)

    <ggplot: (2996810309364)>

![png](speclet-four_SpecletFour-debug_MCMC_files/speclet-four_SpecletFour-debug_MCMC_18_24.png)

    <ggplot: (2996087019548)>

![png](speclet-four_SpecletFour-debug_MCMC_files/speclet-four_SpecletFour-debug_MCMC_18_26.png)

    <ggplot: (2996810623344)>
...
![png](speclet-four_SpecletFour-debug_MCMC_files/speclet-four_SpecletFour-debug_MCMC_22_0.png)
...
```
    ...
    Pareto k diagnostic values:
                             Count   Pct.
    (-Inf, 0.5]   (good)     33925   98.6%
     (0.5, 0.7]   (ok)         384    1.1%
       (0.7, 1]   (bad)         88    0.3%
       (1, Inf)   (very bad)    11    0.0%
...
![png](speclet-four_SpecletFour-debug_MCMC_files/speclet-four_SpecletFour-debug_MCMC_24_2.png)
...
![png](speclet-four_SpecletFour-debug_MCMC_files/speclet-four_SpecletFour-debug_MCMC_26_0.png)

    <ggplot: (2996810292637)>
...
![png](speclet-four_SpecletFour-debug_MCMC_files/speclet-four_SpecletFour-debug_MCMC_27_0.png)

    <ggplot: (2996023749163)>
...
![png](speclet-four_SpecletFour-debug_MCMC_files/speclet-four_SpecletFour-debug_MCMC_28_0.png)

    <ggplot: (3000291422004)>
...
![png](speclet-four_SpecletFour-debug_MCMC_files/speclet-four_SpecletFour-debug_MCMC_29_0.png)

    <ggplot: (2996810104944)>
...
![png](speclet-four_SpecletFour-debug_MCMC_files/speclet-four_SpecletFour-debug_MCMC_30_0.png)

    <ggplot: (2996810759048)>
...
![png](speclet-four_SpecletFour-debug_MCMC_files/speclet-four_SpecletFour-debug_MCMC_31_0.png)

    <ggplot: (2996810376018)>
...
![png](speclet-four_SpecletFour-debug_MCMC_files/speclet-four_SpecletFour-debug_MCMC_32_0.png)

    <ggplot: (3000291429599)>
...
![png](speclet-four_SpecletFour-debug_MCMC_files/speclet-four_SpecletFour-debug_MCMC_33_0.png)

    <ggplot: (2996083679311)>
...
![png](speclet-four_SpecletFour-debug_MCMC_files/speclet-four_SpecletFour-debug_MCMC_34_0.png)

    <ggplot: (2996090402395)>
...
```
    ...
    Hostname: compute-a-16-41.o2.rc.hms.harvard.edu
