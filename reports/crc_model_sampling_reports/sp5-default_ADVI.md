...
```
    ...
    Pareto k diagnostic values:
                             Count   Pct.
    (-Inf, 0.5]   (good)     1036   71.8%
     (0.5, 0.7]   (ok)        315   21.8%
       (0.7, 1]   (bad)        80    5.5%
       (1, Inf)   (very bad)   12    0.8%
