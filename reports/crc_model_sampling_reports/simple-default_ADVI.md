...
<table border="1" class="dataframe">
  ...
  <tbody>
    <tr>
      <th>0</th>
      <td>GCATCAGTCATGCTAACCAA</td>
      <td>LS513-311Cas9_RepA_p6_batch2</td>
      <td>0.296921</td>
      <td>2</td>
      <td>chr2_157587332_-</td>
      <td>ACVR1C</td>
      <td>broad</td>
      <td>True</td>
      <td>2</td>
...
![svg](simple-default_ADVI_files/simple-default_ADVI_15_0.svg)
...
![png](simple-default_ADVI_files/simple-default_ADVI_17_0.png)

![png](simple-default_ADVI_files/simple-default_ADVI_17_1.png)

![png](simple-default_ADVI_files/simple-default_ADVI_17_2.png)
...
![png](simple-default_ADVI_files/simple-default_ADVI_20_0.png)

    <ggplot: (8764022112555)>

![png](simple-default_ADVI_files/simple-default_ADVI_20_2.png)

    <ggplot: (8764022105489)>
...
```
    ...
    /n/data1/hms/dbmi/park/Cook/speclet/.snakemake/conda/daab5ac56849df6113f96e98614e98ee/lib/python3.9/site-packages/arviz/stats/stats.py:456: FutureWarning: hdi currently interprets 2d data as (draw, shape) but this will change in a future release to (chain, draw) for coherence with other functions
...
![png](simple-default_ADVI_files/simple-default_ADVI_24_0.png)
...
```
    ...
    Computed from 1000 by 570 log-likelihood matrix

             Estimate       SE
    elpd_loo  -592.38    25.21
    p_loo        7.77        -
    ------

    Pareto k diagnostic values:
                             Count   Pct.
    (-Inf, 0.5]   (good)      570  100.0%
     (0.5, 0.7]   (ok)          0    0.0%
       (0.7, 1]   (bad)         0    0.0%
...
```
    ...
    /n/data1/hms/dbmi/park/Cook/speclet/.snakemake/conda/daab5ac56849df6113f96e98614e98ee/lib/python3.9/site-packages/seaborn/distributions.py:2557: FutureWarning: `distplot` is a deprecated function and will be removed in a future version. Please adapt your code to use either `displot` (a figure-level function with similar flexibility) or `histplot` (an axes-level function for histograms).
...
![png](simple-default_ADVI_files/simple-default_ADVI_26_2.png)
...
![png](simple-default_ADVI_files/simple-default_ADVI_28_0.png)

    <ggplot: (8764021932927)>
...
![png](simple-default_ADVI_files/simple-default_ADVI_29_0.png)

    <ggplot: (8764021932942)>
...
![png](simple-default_ADVI_files/simple-default_ADVI_30_0.png)

    <ggplot: (8764022075365)>
...
![png](simple-default_ADVI_files/simple-default_ADVI_31_0.png)

    <ggplot: (8764019285968)>
...
![png](simple-default_ADVI_files/simple-default_ADVI_32_0.png)

    <ggplot: (8764021949483)>
...
![png](simple-default_ADVI_files/simple-default_ADVI_33_0.png)

    <ggplot: (8764022075293)>
...
![png](simple-default_ADVI_files/simple-default_ADVI_34_0.png)

    <ggplot: (8764019353932)>
...
![png](simple-default_ADVI_files/simple-default_ADVI_35_0.png)

    <ggplot: (8764014373370)>
...
![png](simple-default_ADVI_files/simple-default_ADVI_36_0.png)

    <ggplot: (8764014365690)>
