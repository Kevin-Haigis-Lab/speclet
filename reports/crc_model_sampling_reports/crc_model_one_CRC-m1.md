...
```
    ...
    /n/data2/dfci/cancerbio/haigis/Cook/speclet/.snakemake/conda/f4a519a1/lib/python3.9/site-packages/pymc3/data.py:316: FutureWarning: Using a non-tuple sequence for multidimensional indexing is deprecated; use `arr[tuple(seq)]` instead of `arr[seq]`. In the future this will be interpreted as an array index, `arr[np.array(seq)]`, which will result either in an error or a different result.
    (INFO) finished; execution time: 1.34 minutes
...
![svg](crc_model_one_CRC-m1_files/crc_model_one_CRC-m1_13_0.svg)
...
![png](crc_model_one_CRC-m1_files/crc_model_one_CRC-m1_15_0.png)

    <ggplot: (2967410049118)>
...
![png](crc_model_one_CRC-m1_files/crc_model_one_CRC-m1_18_0.png)

    <ggplot: (2967410070381)>

![png](crc_model_one_CRC-m1_files/crc_model_one_CRC-m1_18_2.png)

    <ggplot: (2967419935043)>

![png](crc_model_one_CRC-m1_files/crc_model_one_CRC-m1_18_4.png)

    <ggplot: (2967418578583)>

![png](crc_model_one_CRC-m1_files/crc_model_one_CRC-m1_18_6.png)

    <ggplot: (2967419543025)>

![png](crc_model_one_CRC-m1_files/crc_model_one_CRC-m1_18_8.png)

    <ggplot: (2967419864881)>

![png](crc_model_one_CRC-m1_files/crc_model_one_CRC-m1_18_10.png)

    <ggplot: (2967418629087)>

![png](crc_model_one_CRC-m1_files/crc_model_one_CRC-m1_18_12.png)

    <ggplot: (2967419935013)>

![png](crc_model_one_CRC-m1_files/crc_model_one_CRC-m1_18_14.png)

    <ggplot: (2967419959619)>

![png](crc_model_one_CRC-m1_files/crc_model_one_CRC-m1_18_16.png)

    <ggplot: (2967418551050)>

![png](crc_model_one_CRC-m1_files/crc_model_one_CRC-m1_18_18.png)

    <ggplot: (2967418730165)>

![png](crc_model_one_CRC-m1_files/crc_model_one_CRC-m1_18_20.png)

    <ggplot: (2967419603252)>

![png](crc_model_one_CRC-m1_files/crc_model_one_CRC-m1_18_22.png)

    <ggplot: (2967419973666)>

![png](crc_model_one_CRC-m1_files/crc_model_one_CRC-m1_18_24.png)

    <ggplot: (2967418949885)>
...
![png](crc_model_one_CRC-m1_files/crc_model_one_CRC-m1_21_1.png)
...
```
    ...
    Computed from 1000 by 34760 log-likelihood matrix
             ...
             Estimate       SE
    elpd_loo -22808.22   207.66
    p_loo     1076.28        -
    ------

    Pareto k diagnostic values:
                             Count   Pct.
    (-Inf, 0.5]   (good)     34749  100.0%
     (0.5, 0.7]   (ok)          11    0.0%
       (0.7, 1]   (bad)          0    0.0%
...
![png](crc_model_one_CRC-m1_files/crc_model_one_CRC-m1_23_2.png)
...
![png](crc_model_one_CRC-m1_files/crc_model_one_CRC-m1_25_0.png)

    <ggplot: (2967418663771)>
...
![png](crc_model_one_CRC-m1_files/crc_model_one_CRC-m1_26_0.png)

    <ggplot: (2967419053111)>
...
![png](crc_model_one_CRC-m1_files/crc_model_one_CRC-m1_27_0.png)

    <ggplot: (2967418533861)>
...
![png](crc_model_one_CRC-m1_files/crc_model_one_CRC-m1_28_0.png)

    <ggplot: (2967418602951)>
...
![png](crc_model_one_CRC-m1_files/crc_model_one_CRC-m1_29_0.png)

    <ggplot: (2967419231275)>
...
![png](crc_model_one_CRC-m1_files/crc_model_one_CRC-m1_30_0.png)

    <ggplot: (2967419529590)>
...
![png](crc_model_one_CRC-m1_files/crc_model_one_CRC-m1_31_0.png)

    <ggplot: (2967419529599)>
...
![png](crc_model_one_CRC-m1_files/crc_model_one_CRC-m1_32_0.png)

    <ggplot: (2967421846504)>
...
![png](crc_model_one_CRC-m1_files/crc_model_one_CRC-m1_33_0.png)

    <ggplot: (2967419414230)>
