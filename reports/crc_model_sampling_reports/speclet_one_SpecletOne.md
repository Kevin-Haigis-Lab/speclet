...
```
    ...
    /n/data2/dfci/cancerbio/haigis/Cook/speclet/.snakemake/conda/f4a519a1/lib/python3.9/site-packages/pymc3/data.py:316: FutureWarning: Using a non-tuple sequence for multidimensional indexing is deprecated; use `arr[tuple(seq)]` instead of `arr[seq]`. In the future this will be interpreted as an array index, `arr[np.array(seq)]`, which will result either in an error or a different result.
    (INFO) finished; execution time: 3.84 minutes
...
![svg](speclet_one_SpecletOne_files/speclet_one_SpecletOne_13_0.svg)
...
![png](speclet_one_SpecletOne_files/speclet_one_SpecletOne_15_0.png)

    <ggplot: (2972791851737)>
...
```
    ...
    Skipping variable 'd'.
    Must pass 2-d input. shape=(1000, 3957, 36)

![png](speclet_one_SpecletOne_files/speclet_one_SpecletOne_18_1.png)

    <ggplot: (2972800304315)>

![png](speclet_one_SpecletOne_files/speclet_one_SpecletOne_18_3.png)

    <ggplot: (2972800308309)>

![png](speclet_one_SpecletOne_files/speclet_one_SpecletOne_18_5.png)

    <ggplot: (2972814472849)>
    Skipping variable 'μ_d'.
    Must pass 2-d input. shape=(1000, 997, 36)

![png](speclet_one_SpecletOne_files/speclet_one_SpecletOne_18_7.png)

    <ggplot: (2972791847346)>

![png](speclet_one_SpecletOne_files/speclet_one_SpecletOne_18_9.png)

    <ggplot: (2972800308493)>

![png](speclet_one_SpecletOne_files/speclet_one_SpecletOne_18_11.png)

    <ggplot: (2972802153632)>

![png](speclet_one_SpecletOne_files/speclet_one_SpecletOne_18_13.png)

    <ggplot: (2972800315016)>

![png](speclet_one_SpecletOne_files/speclet_one_SpecletOne_18_15.png)

    <ggplot: (2972800315552)>

![png](speclet_one_SpecletOne_files/speclet_one_SpecletOne_18_17.png)

    <ggplot: (2972807694719)>
    Skipping variable 'σ_d'.
    Must pass 2-d input. shape=(1000, 997, 36)

![png](speclet_one_SpecletOne_files/speclet_one_SpecletOne_18_19.png)

    <ggplot: (2972809146314)>

![png](speclet_one_SpecletOne_files/speclet_one_SpecletOne_18_21.png)

    <ggplot: (2972807831549)>

![png](speclet_one_SpecletOne_files/speclet_one_SpecletOne_18_23.png)

    <ggplot: (2972807788581)>

![png](speclet_one_SpecletOne_files/speclet_one_SpecletOne_18_25.png)

    <ggplot: (2972807827282)>

![png](speclet_one_SpecletOne_files/speclet_one_SpecletOne_18_27.png)

    <ggplot: (2972807788608)>

![png](speclet_one_SpecletOne_files/speclet_one_SpecletOne_18_29.png)

    <ggplot: (2972809654077)>

![png](speclet_one_SpecletOne_files/speclet_one_SpecletOne_18_31.png)

    <ggplot: (2972809640912)>
...
![png](speclet_one_SpecletOne_files/speclet_one_SpecletOne_21_1.png)
...
```
    ...
    Pareto k diagnostic values:
                              Count   Pct.
    (-Inf, 0.5]   (good)     310180   88.8%
     (0.5, 0.7]   (ok)        26477    7.6%
       (0.7, 1]   (bad)        9075    2.6%
       (1, Inf)   (very bad)   3452    1.0%
...
![png](speclet_one_SpecletOne_files/speclet_one_SpecletOne_23_2.png)
...
![png](speclet_one_SpecletOne_files/speclet_one_SpecletOne_25_0.png)

    <ggplot: (2971901756904)>
...
![png](speclet_one_SpecletOne_files/speclet_one_SpecletOne_26_0.png)

    <ggplot: (2972815896679)>
...
![png](speclet_one_SpecletOne_files/speclet_one_SpecletOne_27_0.png)

    <ggplot: (2972811154330)>
...
![png](speclet_one_SpecletOne_files/speclet_one_SpecletOne_28_0.png)

    <ggplot: (2972805520029)>
...
![png](speclet_one_SpecletOne_files/speclet_one_SpecletOne_29_0.png)

    <ggplot: (2972809849733)>
...
![png](speclet_one_SpecletOne_files/speclet_one_SpecletOne_30_0.png)

    <ggplot: (2972807777838)>
...
![png](speclet_one_SpecletOne_files/speclet_one_SpecletOne_31_0.png)

    <ggplot: (2972807785418)>
...
![png](speclet_one_SpecletOne_files/speclet_one_SpecletOne_32_0.png)

    <ggplot: (2972813211956)>
...
![png](speclet_one_SpecletOne_files/speclet_one_SpecletOne_33_0.png)

    <ggplot: (2972825050224)>
