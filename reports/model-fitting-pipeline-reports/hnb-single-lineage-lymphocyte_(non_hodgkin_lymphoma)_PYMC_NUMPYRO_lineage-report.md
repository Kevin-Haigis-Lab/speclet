...
```python
# Parameters
MODEL_NAME = "hnb-single-lineage-lymphocyte_(non_hodgkin_lymphoma)"
...
```
    ...
    config. name: 'hnb-single-lineage-lymphocyte_(non_hodgkin_lymphoma)'
    ...
    {
        "name": "hnb-single-lineage-lymphocyte_(non_hodgkin_lymphoma)",
        "description": " Single lineage hierarchical negative binomial model for lymphocyte_(non_hodgkin_lymphoma) data. ",
        "active": true,
        "model": "LINEAGE_HIERARCHICAL_NB",
        "data_file": "modeling_data/sublineage-broad-modeling-data/depmap-modeling-data_lymphocyte_(non_hodgkin_lymphoma).csv",
        "model_kwargs": {
            "lineage": "lymphocyte_(non_hodgkin_lymphoma)",
    ...
    Dimensions:                    (chain: 4, draw: 1000, delta_genes_dim_0: 4,
                                    ...
                                    cell_chrom: 460, genes_chol_cov_dim_0: 10,
    ...
    Coordinates: (12/18)
      ...
      * cell_line                  (cell_line) object 'ACH-000053' ... 'ACH-001616'
    ...
    Attributes:
        created_at:           2022-09-06 11:06:18.274113
        arviz_version:        0.12.1
        model_name:           LineageHierNegBinomModel
        model_version:        0.1.3
        model_doc:            A hierarchical negative binomial generalized linear...
        previous_created_at:  ['2022-09-06 11:06:18.274113', '2022-08-30T13:42:12...
    ...
    BFMI: 0.681, 0.754, 0.758, 0.707
    avg. step size: 0.01, 0.01, 0.01, 0.011
    avg. accept prob.: 0.989, 0.99, 0.988, 0.987
    avg. tree depth: 9.564, 9.0, 10.0, 10.0
...
```
    ...
    [INFO] 2022-09-07 14:59:50 [(lineage_hierarchical_nb.py:data_processing_pipeline:323] Processing data for modeling.
    [INFO] 2022-09-07 14:59:50 [(lineage_hierarchical_nb.py:data_processing_pipeline:324] LFC limits: (-5.0, 5.0)
    [WARNING] 2022-09-07 15:01:31 [(lineage_hierarchical_nb.py:data_processing_pipeline:382] number of data points dropped: 10
    [INFO] 2022-09-07 15:01:33 [(lineage_hierarchical_nb.py:target_gene_is_mutated_vector:630] number of genes mutated in all cells lines: 0
    [INFO] 2022-09-07 15:01:33 [(cancer_gene_mutation_matrix.py:_trim_cancer_genes:77] Dropping 3 cancer genes.
...
![png](hnb-single-lineage-lymphocyte_%28non_hodgkin_lymphoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lymphocyte_%28non_hodgkin_lymphoma%29_PYMC_NUMPYRO_lineage-report_16_0.png)





![png](hnb-single-lineage-lymphocyte_%28non_hodgkin_lymphoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lymphocyte_%28non_hodgkin_lymphoma%29_PYMC_NUMPYRO_lineage-report_16_1.png)
...
![png](hnb-single-lineage-lymphocyte_%28non_hodgkin_lymphoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lymphocyte_%28non_hodgkin_lymphoma%29_PYMC_NUMPYRO_lineage-report_16_3.png)
...
![png](hnb-single-lineage-lymphocyte_%28non_hodgkin_lymphoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lymphocyte_%28non_hodgkin_lymphoma%29_PYMC_NUMPYRO_lineage-report_18_1.png)
...
![png](hnb-single-lineage-lymphocyte_%28non_hodgkin_lymphoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lymphocyte_%28non_hodgkin_lymphoma%29_PYMC_NUMPYRO_lineage-report_19_0.png)
...
![png](hnb-single-lineage-lymphocyte_%28non_hodgkin_lymphoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lymphocyte_%28non_hodgkin_lymphoma%29_PYMC_NUMPYRO_lineage-report_22_1.png)
...
![png](hnb-single-lineage-lymphocyte_%28non_hodgkin_lymphoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lymphocyte_%28non_hodgkin_lymphoma%29_PYMC_NUMPYRO_lineage-report_22_3.png)
...
![png](hnb-single-lineage-lymphocyte_%28non_hodgkin_lymphoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lymphocyte_%28non_hodgkin_lymphoma%29_PYMC_NUMPYRO_lineage-report_22_5.png)
...
![png](hnb-single-lineage-lymphocyte_%28non_hodgkin_lymphoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lymphocyte_%28non_hodgkin_lymphoma%29_PYMC_NUMPYRO_lineage-report_22_7.png)
...
![png](hnb-single-lineage-lymphocyte_%28non_hodgkin_lymphoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lymphocyte_%28non_hodgkin_lymphoma%29_PYMC_NUMPYRO_lineage-report_22_9.png)
...
![png](hnb-single-lineage-lymphocyte_%28non_hodgkin_lymphoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lymphocyte_%28non_hodgkin_lymphoma%29_PYMC_NUMPYRO_lineage-report_22_11.png)
...
![png](hnb-single-lineage-lymphocyte_%28non_hodgkin_lymphoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lymphocyte_%28non_hodgkin_lymphoma%29_PYMC_NUMPYRO_lineage-report_22_13.png)
...
![png](hnb-single-lineage-lymphocyte_%28non_hodgkin_lymphoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lymphocyte_%28non_hodgkin_lymphoma%29_PYMC_NUMPYRO_lineage-report_24_0.png)
...
![png](hnb-single-lineage-lymphocyte_%28non_hodgkin_lymphoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lymphocyte_%28non_hodgkin_lymphoma%29_PYMC_NUMPYRO_lineage-report_25_0.png)
...
![png](hnb-single-lineage-lymphocyte_%28non_hodgkin_lymphoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lymphocyte_%28non_hodgkin_lymphoma%29_PYMC_NUMPYRO_lineage-report_26_0.png)





![png](hnb-single-lineage-lymphocyte_%28non_hodgkin_lymphoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lymphocyte_%28non_hodgkin_lymphoma%29_PYMC_NUMPYRO_lineage-report_26_1.png)
...
![png](hnb-single-lineage-lymphocyte_%28non_hodgkin_lymphoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lymphocyte_%28non_hodgkin_lymphoma%29_PYMC_NUMPYRO_lineage-report_28_0.png)
...
![png](hnb-single-lineage-lymphocyte_%28non_hodgkin_lymphoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lymphocyte_%28non_hodgkin_lymphoma%29_PYMC_NUMPYRO_lineage-report_30_0.png)





![png](hnb-single-lineage-lymphocyte_%28non_hodgkin_lymphoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lymphocyte_%28non_hodgkin_lymphoma%29_PYMC_NUMPYRO_lineage-report_30_1.png)
...
![png](hnb-single-lineage-lymphocyte_%28non_hodgkin_lymphoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lymphocyte_%28non_hodgkin_lymphoma%29_PYMC_NUMPYRO_lineage-report_32_0.png)
...
![png](hnb-single-lineage-lymphocyte_%28non_hodgkin_lymphoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lymphocyte_%28non_hodgkin_lymphoma%29_PYMC_NUMPYRO_lineage-report_33_0.png)
...
![png](hnb-single-lineage-lymphocyte_%28non_hodgkin_lymphoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lymphocyte_%28non_hodgkin_lymphoma%29_PYMC_NUMPYRO_lineage-report_35_0.png)
...
```
    ...
    Hostname: compute-a-16-69.o2.rc.hms.harvard.edu
