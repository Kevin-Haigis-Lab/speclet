...
```python
# Parameters
MODEL_NAME = "hnb-single-lineage-lymphocyte_(lymphoma_unspecified)"
...
```
    ...
    config. name: 'hnb-single-lineage-lymphocyte_(lymphoma_unspecified)'
    ...
    {
        "name": "hnb-single-lineage-lymphocyte_(lymphoma_unspecified)",
        "description": " Single lineage hierarchical negative binomial model for lymphocyte_(lymphoma_unspecified) data. ",
        "active": true,
        "model": "LINEAGE_HIERARCHICAL_NB",
        "data_file": "modeling_data/sublineage-broad-modeling-data/depmap-modeling-data_lymphocyte_(lymphoma_unspecified).csv",
        "model_kwargs": {
            "lineage": "lymphocyte_(lymphoma_unspecified)",
    ...
    Coordinates: (12/18)
      ...
      * cell_line                  (cell_line) object 'ACH-001134' ... 'ACH-002062'
    ...
    Attributes:
        created_at:           2022-09-29 02:12:22.751698
        arviz_version:        0.12.1
        model_name:           LineageHierNegBinomModel
        model_version:        0.1.3
        model_doc:            A hierarchical negative binomial generalized linear...
        previous_created_at:  ['2022-09-29 02:12:22.751698', '2022-09-28T00:03:58...
    ...
    date created: 2022-09-29 02:12
    sampled 4 chains with (unknown) tuning steps and 1,000 draws
    num. divergences: 0, 0, 0, 0
    percent divergences: 0.0, 0.0, 0.0, 0.0
    BFMI: 0.559, 0.624, 0.608, 0.731
    avg. step size: 0.005, 0.009, 0.007, 0.007
    avg. accept prob.: 0.994, 0.98, 0.99, 0.989
    avg. tree depth: 10.0, 9.0, 9.0, 9.0
...
```
    ...
    [INFO] 2022-09-29 03:16:51 [(lineage_hierarchical_nb.py:data_processing_pipeline:323] Processing data for modeling.
    [INFO] 2022-09-29 03:16:51 [(lineage_hierarchical_nb.py:data_processing_pipeline:324] LFC limits: (-5.0, 5.0)
    [WARNING] 2022-09-29 03:18:02 [(lineage_hierarchical_nb.py:data_processing_pipeline:382] number of data points dropped: 8
    [INFO] 2022-09-29 03:18:02 [(lineage_hierarchical_nb.py:target_gene_is_mutated_vector:630] number of genes mutated in all cells lines: 0
    [INFO] 2022-09-29 03:18:02 [(cancer_gene_mutation_matrix.py:_trim_cancer_genes:77] Dropping 7 cancer genes.
...
![png](hnb-single-lineage-lymphocyte_%28lymphoma_unspecified%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lymphocyte_%28lymphoma_unspecified%29_PYMC_NUMPYRO_lineage-report_16_0.png)





![png](hnb-single-lineage-lymphocyte_%28lymphoma_unspecified%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lymphocyte_%28lymphoma_unspecified%29_PYMC_NUMPYRO_lineage-report_16_1.png)
...
![png](hnb-single-lineage-lymphocyte_%28lymphoma_unspecified%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lymphocyte_%28lymphoma_unspecified%29_PYMC_NUMPYRO_lineage-report_16_3.png)
...
![png](hnb-single-lineage-lymphocyte_%28lymphoma_unspecified%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lymphocyte_%28lymphoma_unspecified%29_PYMC_NUMPYRO_lineage-report_18_1.png)
...
![png](hnb-single-lineage-lymphocyte_%28lymphoma_unspecified%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lymphocyte_%28lymphoma_unspecified%29_PYMC_NUMPYRO_lineage-report_19_0.png)
...
![png](hnb-single-lineage-lymphocyte_%28lymphoma_unspecified%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lymphocyte_%28lymphoma_unspecified%29_PYMC_NUMPYRO_lineage-report_22_1.png)
...
![png](hnb-single-lineage-lymphocyte_%28lymphoma_unspecified%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lymphocyte_%28lymphoma_unspecified%29_PYMC_NUMPYRO_lineage-report_22_3.png)
...
![png](hnb-single-lineage-lymphocyte_%28lymphoma_unspecified%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lymphocyte_%28lymphoma_unspecified%29_PYMC_NUMPYRO_lineage-report_22_5.png)
...
![png](hnb-single-lineage-lymphocyte_%28lymphoma_unspecified%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lymphocyte_%28lymphoma_unspecified%29_PYMC_NUMPYRO_lineage-report_22_7.png)
...
![png](hnb-single-lineage-lymphocyte_%28lymphoma_unspecified%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lymphocyte_%28lymphoma_unspecified%29_PYMC_NUMPYRO_lineage-report_22_9.png)
...
![png](hnb-single-lineage-lymphocyte_%28lymphoma_unspecified%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lymphocyte_%28lymphoma_unspecified%29_PYMC_NUMPYRO_lineage-report_22_11.png)
...
![png](hnb-single-lineage-lymphocyte_%28lymphoma_unspecified%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lymphocyte_%28lymphoma_unspecified%29_PYMC_NUMPYRO_lineage-report_22_13.png)
...
![png](hnb-single-lineage-lymphocyte_%28lymphoma_unspecified%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lymphocyte_%28lymphoma_unspecified%29_PYMC_NUMPYRO_lineage-report_24_0.png)
...
![png](hnb-single-lineage-lymphocyte_%28lymphoma_unspecified%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lymphocyte_%28lymphoma_unspecified%29_PYMC_NUMPYRO_lineage-report_25_0.png)
...
![png](hnb-single-lineage-lymphocyte_%28lymphoma_unspecified%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lymphocyte_%28lymphoma_unspecified%29_PYMC_NUMPYRO_lineage-report_26_0.png)





![png](hnb-single-lineage-lymphocyte_%28lymphoma_unspecified%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lymphocyte_%28lymphoma_unspecified%29_PYMC_NUMPYRO_lineage-report_26_1.png)
...
![png](hnb-single-lineage-lymphocyte_%28lymphoma_unspecified%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lymphocyte_%28lymphoma_unspecified%29_PYMC_NUMPYRO_lineage-report_28_0.png)
...
![png](hnb-single-lineage-lymphocyte_%28lymphoma_unspecified%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lymphocyte_%28lymphoma_unspecified%29_PYMC_NUMPYRO_lineage-report_30_0.png)





![png](hnb-single-lineage-lymphocyte_%28lymphoma_unspecified%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lymphocyte_%28lymphoma_unspecified%29_PYMC_NUMPYRO_lineage-report_30_1.png)
...
![png](hnb-single-lineage-lymphocyte_%28lymphoma_unspecified%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lymphocyte_%28lymphoma_unspecified%29_PYMC_NUMPYRO_lineage-report_32_0.png)
...
![png](hnb-single-lineage-lymphocyte_%28lymphoma_unspecified%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lymphocyte_%28lymphoma_unspecified%29_PYMC_NUMPYRO_lineage-report_33_0.png)
...
![png](hnb-single-lineage-lymphocyte_%28lymphoma_unspecified%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lymphocyte_%28lymphoma_unspecified%29_PYMC_NUMPYRO_lineage-report_35_0.png)
...
```
    ...
    Hostname: compute-a-17-88.o2.rc.hms.harvard.edu
