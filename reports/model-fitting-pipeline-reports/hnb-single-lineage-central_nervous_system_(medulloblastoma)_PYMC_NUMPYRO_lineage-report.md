...
```
    ...
    config. name: 'hnb-single-lineage-central_nervous_system_(medulloblastoma)'
    ...
    {
        "name": "hnb-single-lineage-central_nervous_system_(medulloblastoma)",
        "description": " Single lineage hierarchical negative binomial model for central_nervous_system_(medulloblastoma) data. ",
        "active": true,
        "model": "LINEAGE_HIERARCHICAL_NB",
        "data_file": "modeling_data/sublineage-broad-modeling-data/depmap-modeling-data_central_nervous_system_(medulloblastoma).csv",
        "model_kwargs": {
            "lineage": "central_nervous_system_(medulloblastoma)",
    ...
    Dimensions:                    (chain: 4, draw: 1000, delta_genes_dim_0: 5,
                                    ...
                                    cell_chrom: 161, genes_chol_cov_dim_0: 15,
    ...
    Coordinates: (12/19)
      ...
      * cancer_gene                (cancer_gene) object 'TP53'
      ...
      * cell_line                  (cell_line) object 'ACH-000055' ... 'ACH-001232'
    ...
    Attributes:
        created_at:           2022-09-29 02:32:10.210367
        arviz_version:        0.12.1
        model_name:           LineageHierNegBinomModel
        model_version:        0.1.3
        model_doc:            A hierarchical negative binomial generalized linear...
        previous_created_at:  ['2022-09-29 02:32:10.210367', '2022-09-28T20:14:34...
    ...
    date created: 2022-09-29 02:32
    sampled 4 chains with (unknown) tuning steps and 1,000 draws
    num. divergences: 0, 0, 0, 0
    percent divergences: 0.0, 0.0, 0.0, 0.0
    BFMI: 0.726, 0.67, 0.747, 0.689
    avg. step size: 0.008, 0.009, 0.009, 0.008
    avg. accept prob.: 0.991, 0.989, 0.99, 0.991
...
```
    ...
    [INFO] 2022-09-29 03:25:24 [(lineage_hierarchical_nb.py:data_processing_pipeline:323] Processing data for modeling.
    [INFO] 2022-09-29 03:25:24 [(lineage_hierarchical_nb.py:data_processing_pipeline:324] LFC limits: (-5.0, 5.0)
    [WARNING] 2022-09-29 03:26:43 [(lineage_hierarchical_nb.py:data_processing_pipeline:382] number of data points dropped: 0
    [INFO] 2022-09-29 03:26:44 [(lineage_hierarchical_nb.py:target_gene_is_mutated_vector:630] number of genes mutated in all cells lines: 0
    [INFO] 2022-09-29 03:26:44 [(cancer_gene_mutation_matrix.py:_trim_cancer_genes:77] Dropping 23 cancer genes.
...
![png](hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_16_0.png)





![png](hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_16_1.png)
...
![png](hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_16_3.png)
...
![png](hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_18_0.png)
...
![png](hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_19_0.png)
...
![png](hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_22_1.png)
...
![png](hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_22_3.png)
...
![png](hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_22_5.png)
...
![png](hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_22_7.png)
...
![png](hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_22_9.png)
...
![png](hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_22_11.png)
...
![png](hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_22_13.png)
...
![png](hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_23_0.png)
...
![png](hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_23_2.png)
...
![png](hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_24_0.png)
...
![png](hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_25_0.png)
...
![png](hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_26_0.png)





![png](hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_26_1.png)
...
![png](hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_28_0.png)
...
![png](hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_30_0.png)





![png](hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_30_1.png)
...
![png](hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_32_0.png)
...
![png](hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_33_0.png)
...
![png](hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-central_nervous_system_%28medulloblastoma%29_PYMC_NUMPYRO_lineage-report_35_0.png)
...
```
    ...
    Hostname: compute-a-17-64.o2.rc.hms.harvard.edu
