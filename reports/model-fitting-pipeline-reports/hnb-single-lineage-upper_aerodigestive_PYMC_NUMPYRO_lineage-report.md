...
```python
# Parameters
MODEL_NAME = "hnb-single-lineage-upper_aerodigestive"
...
```
    ...
    config. name: 'hnb-single-lineage-upper_aerodigestive'
    ...
    {
        "name": "hnb-single-lineage-upper_aerodigestive",
        "description": " Single lineage hierarchical negative binomial model for upper_aerodigestive data. ",
        "active": true,
        "model": "LINEAGE_HIERARCHICAL_NB",
        "data_file": "modeling_data/sublineage-broad-modeling-data/depmap-modeling-data_upper_aerodigestive.csv",
        "model_kwargs": {
            "lineage": "upper_aerodigestive",
    ...
    Dimensions:                    (chain: 4, draw: 1000, delta_genes_dim_0: 4,
                                    ...
                                    delta_cells_dim_0: 2, delta_cells_dim_1: 46,
                                    cell_chrom: 1058, genes_chol_cov_dim_0: 10,
                                    ...
                                    cells_chol_cov_stds_dim_0: 2, cell_line: 46)
    Coordinates: (12/18)
      ...
      * cell_line                  (cell_line) object 'ACH-000188' ... 'ACH-002045'
    ...
    Attributes:
        created_at:           2022-09-06 11:05:02.008083
        arviz_version:        0.12.1
        model_name:           LineageHierNegBinomModel
        model_version:        0.1.3
        model_doc:            A hierarchical negative binomial generalized linear...
        previous_created_at:  ['2022-09-06 11:05:02.008083', '2022-08-30T00:02:17...
    ...
    BFMI: 0.751, 0.736, 0.65, 0.726
    avg. step size: 0.007, 0.009, 0.006, 0.007
    avg. accept prob.: 0.989, 0.982, 0.99, 0.988
...
```
    ...
    [INFO] 2022-09-07 16:18:23 [(lineage_hierarchical_nb.py:data_processing_pipeline:323] Processing data for modeling.
    [INFO] 2022-09-07 16:18:23 [(lineage_hierarchical_nb.py:data_processing_pipeline:324] LFC limits: (-5.0, 5.0)
    [WARNING] 2022-09-07 16:20:39 [(lineage_hierarchical_nb.py:data_processing_pipeline:382] number of data points dropped: 46
    [INFO] 2022-09-07 16:20:42 [(lineage_hierarchical_nb.py:target_gene_is_mutated_vector:630] number of genes mutated in all cells lines: 0
    [INFO] 2022-09-07 16:20:46 [(cancer_gene_mutation_matrix.py:_trim_cancer_genes:77] Dropping 34 cancer genes.
...
![png](hnb-single-lineage-upper_aerodigestive_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-upper_aerodigestive_PYMC_NUMPYRO_lineage-report_16_0.png)





![png](hnb-single-lineage-upper_aerodigestive_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-upper_aerodigestive_PYMC_NUMPYRO_lineage-report_16_1.png)
...
![png](hnb-single-lineage-upper_aerodigestive_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-upper_aerodigestive_PYMC_NUMPYRO_lineage-report_16_3.png)
...
![png](hnb-single-lineage-upper_aerodigestive_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-upper_aerodigestive_PYMC_NUMPYRO_lineage-report_18_1.png)
...
![png](hnb-single-lineage-upper_aerodigestive_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-upper_aerodigestive_PYMC_NUMPYRO_lineage-report_19_0.png)
...
![png](hnb-single-lineage-upper_aerodigestive_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-upper_aerodigestive_PYMC_NUMPYRO_lineage-report_22_1.png)
...
![png](hnb-single-lineage-upper_aerodigestive_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-upper_aerodigestive_PYMC_NUMPYRO_lineage-report_22_3.png)
...
![png](hnb-single-lineage-upper_aerodigestive_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-upper_aerodigestive_PYMC_NUMPYRO_lineage-report_22_5.png)
...
![png](hnb-single-lineage-upper_aerodigestive_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-upper_aerodigestive_PYMC_NUMPYRO_lineage-report_22_7.png)
...
![png](hnb-single-lineage-upper_aerodigestive_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-upper_aerodigestive_PYMC_NUMPYRO_lineage-report_22_9.png)
...
![png](hnb-single-lineage-upper_aerodigestive_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-upper_aerodigestive_PYMC_NUMPYRO_lineage-report_22_11.png)
...
![png](hnb-single-lineage-upper_aerodigestive_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-upper_aerodigestive_PYMC_NUMPYRO_lineage-report_22_13.png)
...
![png](hnb-single-lineage-upper_aerodigestive_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-upper_aerodigestive_PYMC_NUMPYRO_lineage-report_24_0.png)
...
![png](hnb-single-lineage-upper_aerodigestive_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-upper_aerodigestive_PYMC_NUMPYRO_lineage-report_25_0.png)
...
![png](hnb-single-lineage-upper_aerodigestive_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-upper_aerodigestive_PYMC_NUMPYRO_lineage-report_26_0.png)





![png](hnb-single-lineage-upper_aerodigestive_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-upper_aerodigestive_PYMC_NUMPYRO_lineage-report_26_1.png)
...
![png](hnb-single-lineage-upper_aerodigestive_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-upper_aerodigestive_PYMC_NUMPYRO_lineage-report_28_0.png)
...
![png](hnb-single-lineage-upper_aerodigestive_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-upper_aerodigestive_PYMC_NUMPYRO_lineage-report_30_0.png)





![png](hnb-single-lineage-upper_aerodigestive_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-upper_aerodigestive_PYMC_NUMPYRO_lineage-report_30_1.png)
...
![png](hnb-single-lineage-upper_aerodigestive_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-upper_aerodigestive_PYMC_NUMPYRO_lineage-report_32_0.png)
...
![png](hnb-single-lineage-upper_aerodigestive_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-upper_aerodigestive_PYMC_NUMPYRO_lineage-report_33_0.png)
...
![png](hnb-single-lineage-upper_aerodigestive_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-upper_aerodigestive_PYMC_NUMPYRO_lineage-report_35_0.png)
