...
```python
# Parameters
MODEL_NAME = "hnb-single-lineage-soft_tissue_(rhabdomyosarcoma)"
...
```
    ...
    config. name: 'hnb-single-lineage-soft_tissue_(rhabdomyosarcoma)'
    ...
    {
        "name": "hnb-single-lineage-soft_tissue_(rhabdomyosarcoma)",
        "description": " Single lineage hierarchical negative binomial model for soft_tissue_(rhabdomyosarcoma) data. ",
        "active": true,
        "model": "LINEAGE_HIERARCHICAL_NB",
        "data_file": "modeling_data/sublineage-broad-modeling-data/depmap-modeling-data_soft_tissue_(rhabdomyosarcoma).csv",
        "model_kwargs": {
            "lineage": "soft_tissue_(rhabdomyosarcoma)",
    ...
    Dimensions:                    (chain: 4, draw: 1000, delta_genes_dim_0: 4,
                                    ...
                                    delta_cells_dim_0: 2, delta_cells_dim_1: 10,
                                    cell_chrom: 230, genes_chol_cov_dim_0: 10,
                                    ...
                                    cells_chol_cov_stds_dim_0: 2, cell_line: 10)
    Coordinates: (12/18)
      ...
      * cell_line                  (cell_line) object 'ACH-000169' ... 'ACH-001765'
    ...
    Attributes:
        created_at:           2022-09-06 11:08:41.324294
        arviz_version:        0.12.1
        model_name:           LineageHierNegBinomModel
        model_version:        0.1.3
        model_doc:            A hierarchical negative binomial generalized linear...
        previous_created_at:  ['2022-09-06 11:08:41.324294', '2022-08-29T16:20:00...
    ...
    date created: 2022-09-06 11:08
    sampled 4 chains with (unknown) tuning steps and 1,000 draws
    num. divergences: 0, 0, 0, 0
    percent divergences: 0.0, 0.0, 0.0, 0.0
    BFMI: 0.66, 0.773, 0.739, 0.752
    avg. step size: 0.01, 0.009, 0.008, 0.008
    avg. accept prob.: 0.984, 0.987, 0.99, 0.989
    avg. tree depth: 9.994, 9.0, 9.0, 9.0
...
```
    ...
    [INFO] 2022-09-07 14:58:00 [(lineage_hierarchical_nb.py:data_processing_pipeline:323] Processing data for modeling.
    [INFO] 2022-09-07 14:58:00 [(lineage_hierarchical_nb.py:data_processing_pipeline:324] LFC limits: (-5.0, 5.0)
    [WARNING] 2022-09-07 14:59:27 [(lineage_hierarchical_nb.py:data_processing_pipeline:382] number of data points dropped: 0
    [INFO] 2022-09-07 14:59:28 [(lineage_hierarchical_nb.py:target_gene_is_mutated_vector:630] number of genes mutated in all cells lines: 0
    [INFO] 2022-09-07 14:59:28 [(cancer_gene_mutation_matrix.py:_trim_cancer_genes:77] Dropping 2 cancer genes.
...
![png](hnb-single-lineage-soft_tissue_%28rhabdomyosarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28rhabdomyosarcoma%29_PYMC_NUMPYRO_lineage-report_16_0.png)





![png](hnb-single-lineage-soft_tissue_%28rhabdomyosarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28rhabdomyosarcoma%29_PYMC_NUMPYRO_lineage-report_16_1.png)
...
![png](hnb-single-lineage-soft_tissue_%28rhabdomyosarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28rhabdomyosarcoma%29_PYMC_NUMPYRO_lineage-report_16_3.png)
...
![png](hnb-single-lineage-soft_tissue_%28rhabdomyosarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28rhabdomyosarcoma%29_PYMC_NUMPYRO_lineage-report_18_1.png)
...
![png](hnb-single-lineage-soft_tissue_%28rhabdomyosarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28rhabdomyosarcoma%29_PYMC_NUMPYRO_lineage-report_19_0.png)
...
![png](hnb-single-lineage-soft_tissue_%28rhabdomyosarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28rhabdomyosarcoma%29_PYMC_NUMPYRO_lineage-report_22_1.png)
...
![png](hnb-single-lineage-soft_tissue_%28rhabdomyosarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28rhabdomyosarcoma%29_PYMC_NUMPYRO_lineage-report_22_3.png)
...
![png](hnb-single-lineage-soft_tissue_%28rhabdomyosarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28rhabdomyosarcoma%29_PYMC_NUMPYRO_lineage-report_22_5.png)
...
![png](hnb-single-lineage-soft_tissue_%28rhabdomyosarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28rhabdomyosarcoma%29_PYMC_NUMPYRO_lineage-report_22_7.png)
...
![png](hnb-single-lineage-soft_tissue_%28rhabdomyosarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28rhabdomyosarcoma%29_PYMC_NUMPYRO_lineage-report_22_9.png)
...
![png](hnb-single-lineage-soft_tissue_%28rhabdomyosarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28rhabdomyosarcoma%29_PYMC_NUMPYRO_lineage-report_22_11.png)
...
![png](hnb-single-lineage-soft_tissue_%28rhabdomyosarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28rhabdomyosarcoma%29_PYMC_NUMPYRO_lineage-report_22_13.png)
...
![png](hnb-single-lineage-soft_tissue_%28rhabdomyosarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28rhabdomyosarcoma%29_PYMC_NUMPYRO_lineage-report_24_0.png)
...
![png](hnb-single-lineage-soft_tissue_%28rhabdomyosarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28rhabdomyosarcoma%29_PYMC_NUMPYRO_lineage-report_25_0.png)
...
![png](hnb-single-lineage-soft_tissue_%28rhabdomyosarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28rhabdomyosarcoma%29_PYMC_NUMPYRO_lineage-report_26_0.png)





![png](hnb-single-lineage-soft_tissue_%28rhabdomyosarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28rhabdomyosarcoma%29_PYMC_NUMPYRO_lineage-report_26_1.png)
...
![png](hnb-single-lineage-soft_tissue_%28rhabdomyosarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28rhabdomyosarcoma%29_PYMC_NUMPYRO_lineage-report_28_0.png)
...
![png](hnb-single-lineage-soft_tissue_%28rhabdomyosarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28rhabdomyosarcoma%29_PYMC_NUMPYRO_lineage-report_30_0.png)





![png](hnb-single-lineage-soft_tissue_%28rhabdomyosarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28rhabdomyosarcoma%29_PYMC_NUMPYRO_lineage-report_30_1.png)
...
![png](hnb-single-lineage-soft_tissue_%28rhabdomyosarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28rhabdomyosarcoma%29_PYMC_NUMPYRO_lineage-report_32_0.png)
...
![png](hnb-single-lineage-soft_tissue_%28rhabdomyosarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28rhabdomyosarcoma%29_PYMC_NUMPYRO_lineage-report_33_0.png)
...
![png](hnb-single-lineage-soft_tissue_%28rhabdomyosarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28rhabdomyosarcoma%29_PYMC_NUMPYRO_lineage-report_35_0.png)
