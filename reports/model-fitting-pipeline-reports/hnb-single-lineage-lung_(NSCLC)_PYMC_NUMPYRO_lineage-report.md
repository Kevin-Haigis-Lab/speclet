...
```python
# Parameters
MODEL_NAME = "hnb-single-lineage-lung_(NSCLC)"
...
```
    ...
    config. name: 'hnb-single-lineage-lung_(NSCLC)'
    ...
    {
        "name": "hnb-single-lineage-lung_(NSCLC)",
        "description": " Single lineage hierarchical negative binomial model for lung_(NSCLC) data. ",
        "active": true,
        "model": "LINEAGE_HIERARCHICAL_NB",
        "data_file": "modeling_data/sublineage-broad-modeling-data/depmap-modeling-data_lung_(NSCLC).csv",
        "model_kwargs": {
            "lineage": "lung_(NSCLC)",
    ...
    Dimensions:                    (chain: 4, draw: 1000, delta_genes_dim_0: 14,
                                    ...
                                    delta_cells_dim_0: 2, delta_cells_dim_1: 83,
                                    cell_chrom: 1909, genes_chol_cov_dim_0: 105,
                                    ...
                                    cells_chol_cov_stds_dim_0: 2, cell_line: 83)
    Coordinates: (12/19)
      ...
      * cancer_gene                (cancer_gene) object 'ALK' 'DROSHA' ... 'STK11'
      ...
      * cell_line                  (cell_line) object 'ACH-000012' ... 'ACH-001075'
    ...
    Attributes:
        created_at:           2022-09-29 18:12:05.390794
        arviz_version:        0.12.1
        model_name:           LineageHierNegBinomModel
        model_version:        0.1.3
        model_doc:            A hierarchical negative binomial generalized linear...
        previous_created_at:  ['2022-09-29 18:12:05.390794', '2022-09-29T14:07:22...
    ...
    date created: 2022-09-29 18:12
    sampled 4 chains with (unknown) tuning steps and 1,000 draws
    num. divergences: 0, 0, 0, 0
    percent divergences: 0.0, 0.0, 0.0, 0.0
    BFMI: 0.714, 0.658, 0.662, 0.826
    avg. step size: 0.007, 0.007, 0.008, 0.009
    avg. accept prob.: 0.989, 0.987, 0.984, 0.982
...
```
    ...
    [INFO] 2022-09-30 02:52:51 [(lineage_hierarchical_nb.py:data_processing_pipeline:323] Processing data for modeling.
    [INFO] 2022-09-30 02:52:51 [(lineage_hierarchical_nb.py:data_processing_pipeline:324] LFC limits: (-5.0, 5.0)
    [WARNING] 2022-09-30 02:56:21 [(lineage_hierarchical_nb.py:data_processing_pipeline:382] number of data points dropped: 64
    [INFO] 2022-09-30 02:56:27 [(lineage_hierarchical_nb.py:target_gene_is_mutated_vector:630] number of genes mutated in all cells lines: 0
    [INFO] 2022-09-30 02:56:35 [(cancer_gene_mutation_matrix.py:_trim_cancer_genes:77] Dropping 18 cancer genes.
...
![png](hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_16_0.png)





![png](hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_16_1.png)
...
![png](hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_16_3.png)
...
![png](hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_18_0.png)
...
![png](hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_19_0.png)
...
```
    ...
    ['ALK', 'DROSHA', 'EGFR', 'ERBB4', 'KDR', 'KEAP1', 'PTPN13', 'RB1', 'SMARCA4', 'STK11']
...
![png](hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_22_1.png)
...
![png](hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_22_3.png)
...
![png](hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_22_5.png)
...
![png](hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_22_7.png)
...
![png](hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_22_9.png)
...
![png](hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_22_11.png)
...
![png](hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_22_13.png)
...
![png](hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_23_0.png)
...
![png](hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_23_2.png)
...
![png](hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_24_0.png)
...
![png](hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_25_0.png)
...
![png](hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_26_0.png)





![png](hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_26_1.png)
...
![png](hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_28_0.png)
...
![png](hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_30_0.png)





![png](hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_30_1.png)
...
![png](hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_31_0.png)





![png](hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_31_1.png)
...
![png](hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_32_0.png)
...
![png](hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_33_0.png)
...
![png](hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28NSCLC%29_PYMC_NUMPYRO_lineage-report_35_0.png)
...
```
    ...
    Hostname: compute-e-16-179.o2.rc.hms.harvard.edu
