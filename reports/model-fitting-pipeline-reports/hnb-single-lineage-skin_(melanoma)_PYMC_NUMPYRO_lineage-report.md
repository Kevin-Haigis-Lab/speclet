...
```python
# Parameters
MODEL_NAME = "hnb-single-lineage-skin_(melanoma)"
...
```
    ...
    config. name: 'hnb-single-lineage-skin_(melanoma)'
    ...
    {
        "name": "hnb-single-lineage-skin_(melanoma)",
        "description": " Single lineage hierarchical negative binomial model for skin_(melanoma) data. ",
        "active": true,
        "model": "LINEAGE_HIERARCHICAL_NB",
        "data_file": "modeling_data/sublineage-broad-modeling-data/depmap-modeling-data_skin_(melanoma).csv",
        "model_kwargs": {
            "lineage": "skin_(melanoma)",
        ...
        "split_posterior_when_combining_chains": true
    }
    ...
    Dimensions:                    (chain: 4, draw: 1000, delta_genes_dim_0: 13,
                                    ...
                                    delta_cells_dim_0: 2, delta_cells_dim_1: 57,
                                    cell_chrom: 1311, genes_chol_cov_dim_0: 91,
                                    ...
                                    cells_chol_cov_stds_dim_0: 2, cell_line: 57)
    Coordinates: (12/19)
      ...
      * cancer_gene                (cancer_gene) object 'CDKN2A' 'FAT4' ... 'TRRAP'
      ...
      * cell_line                  (cell_line) object 'ACH-000014' ... 'ACH-002512'
    ...
    Attributes:
        created_at:           2022-09-06 11:02:23.092760
        arviz_version:        0.12.1
        model_name:           LineageHierNegBinomModel
        model_version:        0.1.3
        model_doc:            A hierarchical negative binomial generalized linear...
        previous_created_at:  ['2022-09-06 11:02:23.092760', '2022-09-04T03:22:14...
    ...
    BFMI: 0.78, 0.735, 0.765, 0.725
    avg. step size: 0.008, 0.007, 0.008, 0.009
    avg. accept prob.: 0.987, 0.989, 0.987, 0.986
...
```
    ...
    [INFO] 2022-09-07 16:18:41 [(lineage_hierarchical_nb.py:data_processing_pipeline:323] Processing data for modeling.
    [INFO] 2022-09-07 16:18:41 [(lineage_hierarchical_nb.py:data_processing_pipeline:324] LFC limits: (-5.0, 5.0)
    [WARNING] 2022-09-07 16:21:34 [(lineage_hierarchical_nb.py:data_processing_pipeline:382] number of data points dropped: 60
    [INFO] 2022-09-07 16:21:38 [(lineage_hierarchical_nb.py:target_gene_is_mutated_vector:630] number of genes mutated in all cells lines: 0
    [INFO] 2022-09-07 16:21:42 [(cancer_gene_mutation_matrix.py:_trim_cancer_genes:77] Dropping 9 cancer genes.
...
![png](hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_16_0.png)





![png](hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_16_1.png)
...
![png](hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_16_3.png)
...
![png](hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_18_0.png)
...
![png](hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_19_0.png)
...
```
    ...
    ['CDKN2A', 'FAT4', 'GRIN2A', 'NRAS', 'POLE', 'PPP6C', 'PREX2', 'PTPRT', 'TRRAP']
...
![png](hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_22_1.png)
...
![png](hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_22_3.png)
...
![png](hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_22_5.png)
...
![png](hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_22_7.png)
...
![png](hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_22_9.png)
...
![png](hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_22_11.png)
...
![png](hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_22_13.png)
...
![png](hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_23_0.png)
...
![png](hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_23_2.png)
...
![png](hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_24_0.png)
...
![png](hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_25_0.png)
...
![png](hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_26_0.png)





![png](hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_26_1.png)
...
![png](hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_28_0.png)
...
![png](hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_30_0.png)





![png](hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_30_1.png)
...
![png](hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_31_0.png)





![png](hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_31_1.png)
...
![png](hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_32_0.png)
...
![png](hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_33_0.png)
...
![png](hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28melanoma%29_PYMC_NUMPYRO_lineage-report_35_0.png)
...
```
    ...
    Hostname: compute-a-16-43.o2.rc.hms.harvard.edu
