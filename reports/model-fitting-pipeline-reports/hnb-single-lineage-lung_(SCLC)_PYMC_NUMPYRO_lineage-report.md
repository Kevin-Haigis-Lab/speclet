...
```
    ...
    config. name: 'hnb-single-lineage-lung_(SCLC)'
    ...
    {
        "name": "hnb-single-lineage-lung_(SCLC)",
        "description": " Single lineage hierarchical negative binomial model for lung_(SCLC) data. ",
        "active": true,
        "model": "LINEAGE_HIERARCHICAL_NB",
        "data_file": "modeling_data/sublineage-broad-modeling-data/depmap-modeling-data_lung_(SCLC).csv",
        "model_kwargs": {
            "lineage": "lung_(SCLC)",
    ...
    <xarray.Dataset>
    Dimensions:                    (chain: 4, draw: 1000, delta_genes_dim_0: 6,
                                    delta_genes_dim_1: 18119, sgrna: 71062,
                                    delta_cells_dim_0: 2, delta_cells_dim_1: 19,
                                    cell_chrom: 437, genes_chol_cov_dim_0: 21,
                                    cells_chol_cov_dim_0: 3,
                                    genes_chol_cov_corr_dim_0: 6,
                                    genes_chol_cov_corr_dim_1: 6,
                                    genes_chol_cov_stds_dim_0: 6, gene: 18119,
                                    cancer_gene: 2, cells_chol_cov_corr_dim_0: 2,
                                    cells_chol_cov_corr_dim_1: 2,
                                    cells_chol_cov_stds_dim_0: 2, cell_line: 19)
    Coordinates: (12/19)
      * chain                      (chain) int64 0 1 2 3
      * draw                       (draw) int64 0 1 2 3 4 5 ... 995 996 997 998 999
      * delta_genes_dim_0          (delta_genes_dim_0) int64 0 1 2 3 4 5
      ...
      * cancer_gene                (cancer_gene) object 'RB1' 'SMARCA4'
      ...
      * cell_line                  (cell_line) object 'ACH-000187' ... 'ACH-001549'
    ...
    Attributes:
        created_at:           2022-09-06 11:04:00.378485
        arviz_version:        0.12.1
        model_name:           LineageHierNegBinomModel
        model_version:        0.1.3
        model_doc:            A hierarchical negative binomial generalized linear...
        previous_created_at:  ['2022-09-06 11:04:00.378485', '2022-08-26T17:28:02...
    ...
    BFMI: 0.67, 0.875, 0.767, 0.739
    avg. step size: 0.008, 0.008, 0.007, 0.009
    avg. accept prob.: 0.99, 0.99, 0.991, 0.988
...
```
    ...
    [INFO] 2022-09-07 14:59:51 [(lineage_hierarchical_nb.py:data_processing_pipeline:323] Processing data for modeling.
    [INFO] 2022-09-07 14:59:51 [(lineage_hierarchical_nb.py:data_processing_pipeline:324] LFC limits: (-5.0, 5.0)
    [WARNING] 2022-09-07 15:01:36 [(lineage_hierarchical_nb.py:data_processing_pipeline:382] number of data points dropped: 25
    [INFO] 2022-09-07 15:01:37 [(lineage_hierarchical_nb.py:target_gene_is_mutated_vector:630] number of genes mutated in all cells lines: 1
    [INFO] 2022-09-07 15:01:38 [(cancer_gene_mutation_matrix.py:_trim_cancer_genes:77] Dropping 15 cancer genes.
...
![png](hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_16_0.png)





![png](hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_16_1.png)
...
![png](hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_16_3.png)
...
![png](hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_18_0.png)
...
![png](hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_19_0.png)
...
![png](hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_22_1.png)
...
![png](hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_22_3.png)
...
![png](hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_22_5.png)
...
![png](hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_22_7.png)
...
![png](hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_22_9.png)
...
![png](hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_22_11.png)
...
![png](hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_22_13.png)
...
![png](hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_23_0.png)





![png](hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_23_1.png)
...
![png](hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_24_0.png)
...
![png](hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_25_0.png)
...
![png](hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_26_0.png)





![png](hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_26_1.png)
...
![png](hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_28_0.png)
...
![png](hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_30_0.png)





![png](hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_30_1.png)
...
![png](hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_31_0.png)



    /home/jc604/.conda/envs/speclet_smk/lib/python3.10/site-packages/seaborn/matrix.py:1203: UserWarning: Tight layout not applied. The left and right margins cannot be made large enough to accommodate all axes decorations.
      self._figure.tight_layout(**tight_params)




![png](hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_31_2.png)
...
![png](hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_32_0.png)
...
![png](hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_33_0.png)
...
![png](hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-lung_%28SCLC%29_PYMC_NUMPYRO_lineage-report_35_0.png)
