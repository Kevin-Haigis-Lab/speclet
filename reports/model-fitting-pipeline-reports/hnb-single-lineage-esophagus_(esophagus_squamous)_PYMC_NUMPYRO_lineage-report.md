...
```python
# Parameters
MODEL_NAME = "hnb-single-lineage-esophagus_(esophagus_squamous)"
...
```
    ...
    config. name: 'hnb-single-lineage-esophagus_(esophagus_squamous)'
    ...
    {
        "name": "hnb-single-lineage-esophagus_(esophagus_squamous)",
        "description": " Single lineage hierarchical negative binomial model for esophagus_(esophagus_squamous) data. ",
        "active": true,
        "model": "LINEAGE_HIERARCHICAL_NB",
        "data_file": "modeling_data/sublineage-broad-modeling-data/depmap-modeling-data_esophagus_(esophagus_squamous).csv",
        "model_kwargs": {
            "lineage": "esophagus_(esophagus_squamous)",
    ...
    Coordinates: (12/19)
      ...
      * cancer_gene                (cancer_gene) object 'LRP1B'
      ...
      * cell_line                  (cell_line) object 'ACH-000305' ... 'ACH-000917'
    ...
    Attributes:
        created_at:           2022-09-29 03:43:29.166912
        arviz_version:        0.12.1
        model_name:           LineageHierNegBinomModel
        model_version:        0.1.3
        model_doc:            A hierarchical negative binomial generalized linear...
        previous_created_at:  ['2022-09-29 03:43:29.166912', '2022-09-28T17:15:08...
    ...
    BFMI: 0.726, 0.679, 0.689, 0.752
    avg. step size: 0.007, 0.008, 0.008, 0.008
    avg. accept prob.: 0.99, 0.988, 0.988, 0.988
    avg. tree depth: 10.0, 9.193, 9.988, 10.0
...
```
    ...
    [INFO] 2022-09-29 05:08:15 [(lineage_hierarchical_nb.py:data_processing_pipeline:323] Processing data for modeling.
    [INFO] 2022-09-29 05:08:15 [(lineage_hierarchical_nb.py:data_processing_pipeline:324] LFC limits: (-5.0, 5.0)
    [WARNING] 2022-09-29 05:10:01 [(lineage_hierarchical_nb.py:data_processing_pipeline:382] number of data points dropped: 4
    [INFO] 2022-09-29 05:10:02 [(lineage_hierarchical_nb.py:target_gene_is_mutated_vector:630] number of genes mutated in all cells lines: 1
    [INFO] 2022-09-29 05:10:03 [(cancer_gene_mutation_matrix.py:_trim_cancer_genes:77] Dropping 3 cancer genes.
...
![png](hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_16_0.png)





![png](hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_16_1.png)
...
![png](hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_16_3.png)
...
![png](hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_18_0.png)
...
![png](hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_19_0.png)
...
![png](hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_22_1.png)
...
![png](hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_22_3.png)
...
![png](hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_22_5.png)
...
![png](hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_22_7.png)
...
![png](hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_22_9.png)
...
![png](hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_22_11.png)
...
![png](hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_22_13.png)
...
![png](hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_23_0.png)
...
![png](hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_23_2.png)
...
![png](hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_24_0.png)
...
![png](hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_25_0.png)
...
![png](hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_26_0.png)





![png](hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_26_1.png)
...
![png](hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_28_0.png)
...
![png](hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_30_0.png)





![png](hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_30_1.png)
...
![png](hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_32_0.png)
...
![png](hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_33_0.png)
...
![png](hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-esophagus_%28esophagus_squamous%29_PYMC_NUMPYRO_lineage-report_35_0.png)
...
```
    ...
    Hostname: compute-a-16-46.o2.rc.hms.harvard.edu
