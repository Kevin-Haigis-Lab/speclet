...
```python
# Parameters
MODEL_NAME = "hnb-single-lineage-soft_tissue_(synovial_sarcoma)"
...
```
    ...
    config. name: 'hnb-single-lineage-soft_tissue_(synovial_sarcoma)'
    ...
    {
        "name": "hnb-single-lineage-soft_tissue_(synovial_sarcoma)",
        "description": " Single lineage hierarchical negative binomial model for soft_tissue_(synovial_sarcoma) data. ",
        "active": true,
        "model": "LINEAGE_HIERARCHICAL_NB",
        "data_file": "modeling_data/sublineage-broad-modeling-data/depmap-modeling-data_soft_tissue_(synovial_sarcoma).csv",
        "model_kwargs": {
            "lineage": "soft_tissue_(synovial_sarcoma)",
    ...
    Coordinates: (12/18)
      ...
      * cell_line                  (cell_line) object 'ACH-001274' ... 'ACH-001322'
    ...
    Attributes:
        created_at:           2022-09-29 02:47:26.908807
        arviz_version:        0.12.1
        model_name:           LineageHierNegBinomModel
        model_version:        0.1.3
        model_doc:            A hierarchical negative binomial generalized linear...
        previous_created_at:  ['2022-09-29 02:47:26.908807', '2022-09-28T11:53:02...
    ...
    BFMI: 0.621, 0.706, 0.776, 0.749
    avg. step size: 0.008, 0.008, 0.008, 0.008
    avg. accept prob.: 0.989, 0.989, 0.989, 0.989
...
```
    ...
    [INFO] 2022-09-29 03:32:45 [(lineage_hierarchical_nb.py:data_processing_pipeline:323] Processing data for modeling.
    [INFO] 2022-09-29 03:32:45 [(lineage_hierarchical_nb.py:data_processing_pipeline:324] LFC limits: (-5.0, 5.0)
    [WARNING] 2022-09-29 03:33:57 [(lineage_hierarchical_nb.py:data_processing_pipeline:382] number of data points dropped: 0
    [INFO] 2022-09-29 03:33:57 [(lineage_hierarchical_nb.py:target_gene_is_mutated_vector:630] number of genes mutated in all cells lines: 0
    [INFO] 2022-09-29 03:33:57 [(cancer_gene_mutation_matrix.py:_trim_cancer_genes:77] Dropping 7 cancer genes.
...
![png](hnb-single-lineage-soft_tissue_%28synovial_sarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28synovial_sarcoma%29_PYMC_NUMPYRO_lineage-report_16_0.png)





![png](hnb-single-lineage-soft_tissue_%28synovial_sarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28synovial_sarcoma%29_PYMC_NUMPYRO_lineage-report_16_1.png)
...
![png](hnb-single-lineage-soft_tissue_%28synovial_sarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28synovial_sarcoma%29_PYMC_NUMPYRO_lineage-report_16_3.png)
...
![png](hnb-single-lineage-soft_tissue_%28synovial_sarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28synovial_sarcoma%29_PYMC_NUMPYRO_lineage-report_18_1.png)
...
![png](hnb-single-lineage-soft_tissue_%28synovial_sarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28synovial_sarcoma%29_PYMC_NUMPYRO_lineage-report_19_0.png)
...
![png](hnb-single-lineage-soft_tissue_%28synovial_sarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28synovial_sarcoma%29_PYMC_NUMPYRO_lineage-report_22_1.png)
...
![png](hnb-single-lineage-soft_tissue_%28synovial_sarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28synovial_sarcoma%29_PYMC_NUMPYRO_lineage-report_22_3.png)
...
![png](hnb-single-lineage-soft_tissue_%28synovial_sarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28synovial_sarcoma%29_PYMC_NUMPYRO_lineage-report_22_5.png)
...
![png](hnb-single-lineage-soft_tissue_%28synovial_sarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28synovial_sarcoma%29_PYMC_NUMPYRO_lineage-report_22_7.png)
...
![png](hnb-single-lineage-soft_tissue_%28synovial_sarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28synovial_sarcoma%29_PYMC_NUMPYRO_lineage-report_22_9.png)
...
![png](hnb-single-lineage-soft_tissue_%28synovial_sarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28synovial_sarcoma%29_PYMC_NUMPYRO_lineage-report_22_11.png)
...
![png](hnb-single-lineage-soft_tissue_%28synovial_sarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28synovial_sarcoma%29_PYMC_NUMPYRO_lineage-report_22_13.png)
...
![png](hnb-single-lineage-soft_tissue_%28synovial_sarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28synovial_sarcoma%29_PYMC_NUMPYRO_lineage-report_24_0.png)
...
![png](hnb-single-lineage-soft_tissue_%28synovial_sarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28synovial_sarcoma%29_PYMC_NUMPYRO_lineage-report_25_0.png)
...
![png](hnb-single-lineage-soft_tissue_%28synovial_sarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28synovial_sarcoma%29_PYMC_NUMPYRO_lineage-report_26_0.png)





![png](hnb-single-lineage-soft_tissue_%28synovial_sarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28synovial_sarcoma%29_PYMC_NUMPYRO_lineage-report_26_1.png)
...
![png](hnb-single-lineage-soft_tissue_%28synovial_sarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28synovial_sarcoma%29_PYMC_NUMPYRO_lineage-report_28_0.png)
...
![png](hnb-single-lineage-soft_tissue_%28synovial_sarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28synovial_sarcoma%29_PYMC_NUMPYRO_lineage-report_30_0.png)





![png](hnb-single-lineage-soft_tissue_%28synovial_sarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28synovial_sarcoma%29_PYMC_NUMPYRO_lineage-report_30_1.png)
...
![png](hnb-single-lineage-soft_tissue_%28synovial_sarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28synovial_sarcoma%29_PYMC_NUMPYRO_lineage-report_32_0.png)
...
![png](hnb-single-lineage-soft_tissue_%28synovial_sarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28synovial_sarcoma%29_PYMC_NUMPYRO_lineage-report_33_0.png)
...
![png](hnb-single-lineage-soft_tissue_%28synovial_sarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28synovial_sarcoma%29_PYMC_NUMPYRO_lineage-report_35_0.png)
