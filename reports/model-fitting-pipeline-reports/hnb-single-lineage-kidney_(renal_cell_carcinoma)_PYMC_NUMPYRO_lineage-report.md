...
```python
# Parameters
MODEL_NAME = "hnb-single-lineage-kidney_(renal_cell_carcinoma)"
...
```
    ...
    config. name: 'hnb-single-lineage-kidney_(renal_cell_carcinoma)'
    ...
    {
        "name": "hnb-single-lineage-kidney_(renal_cell_carcinoma)",
        "description": " Single lineage hierarchical negative binomial model for kidney_(renal_cell_carcinoma) data. ",
        "active": true,
        "model": "LINEAGE_HIERARCHICAL_NB",
        "data_file": "modeling_data/sublineage-broad-modeling-data/depmap-modeling-data_kidney_(renal_cell_carcinoma).csv",
        "model_kwargs": {
            "lineage": "kidney_(renal_cell_carcinoma)",
    ...
    <xarray.Dataset>
    Dimensions:                    (chain: 4, draw: 1000, delta_genes_dim_0: 8,
                                    delta_genes_dim_1: 18119, sgrna: 71062,
                                    delta_cells_dim_0: 2, delta_cells_dim_1: 24,
                                    cell_chrom: 552, genes_chol_cov_dim_0: 36,
                                    cells_chol_cov_dim_0: 3,
                                    genes_chol_cov_corr_dim_0: 8,
                                    genes_chol_cov_corr_dim_1: 8,
                                    genes_chol_cov_stds_dim_0: 8, gene: 18119,
                                    cancer_gene: 4, cells_chol_cov_corr_dim_0: 2,
                                    cells_chol_cov_corr_dim_1: 2,
                                    cells_chol_cov_stds_dim_0: 2, cell_line: 24)
    Coordinates: (12/19)
      * chain                      (chain) int64 0 1 2 3
      * draw                       (draw) int64 0 1 2 3 4 5 ... 995 996 997 998 999
      * delta_genes_dim_0          (delta_genes_dim_0) int64 0 1 2 3 4 5 6 7
      ...
      * cancer_gene                (cancer_gene) object 'MTOR' 'PBRM1' 'SETD2' 'VHL'
      ...
      * cell_line                  (cell_line) object 'ACH-000127' ... 'ACH-001194'
    ...
    Attributes:
        created_at:           2022-09-06 11:03:56.553173
        arviz_version:        0.12.1
        model_name:           LineageHierNegBinomModel
        model_version:        0.1.3
        model_doc:            A hierarchical negative binomial generalized linear...
        previous_created_at:  ['2022-09-06 11:03:56.553173', '2022-08-28T09:00:41...
    ...
    BFMI: 0.712, 0.672, 0.698, 0.713
    avg. step size: 0.008, 0.009, 0.008, 0.008
    avg. accept prob.: 0.99, 0.988, 0.99, 0.988
...
```
    ...
    [INFO] 2022-09-07 14:59:52 [(lineage_hierarchical_nb.py:data_processing_pipeline:323] Processing data for modeling.
    [INFO] 2022-09-07 14:59:52 [(lineage_hierarchical_nb.py:data_processing_pipeline:324] LFC limits: (-5.0, 5.0)
    [WARNING] 2022-09-07 15:01:34 [(lineage_hierarchical_nb.py:data_processing_pipeline:382] number of data points dropped: 13
    [INFO] 2022-09-07 15:01:35 [(lineage_hierarchical_nb.py:target_gene_is_mutated_vector:630] number of genes mutated in all cells lines: 0
    [INFO] 2022-09-07 15:01:36 [(cancer_gene_mutation_matrix.py:_trim_cancer_genes:77] Dropping 4 cancer genes.
...
![png](hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_16_0.png)





![png](hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_16_1.png)
...
![png](hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_16_3.png)
...
![png](hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_18_0.png)
...
![png](hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_19_0.png)
...
![png](hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_22_1.png)
...
![png](hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_22_3.png)
...
![png](hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_22_5.png)
...
![png](hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_22_7.png)
...
![png](hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_22_9.png)
...
![png](hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_22_11.png)
...
![png](hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_22_13.png)
...
![png](hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_23_0.png)
...
![png](hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_23_2.png)
...
![png](hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_24_0.png)
...
![png](hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_25_0.png)
...
![png](hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_26_0.png)





![png](hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_26_1.png)
...
![png](hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_28_0.png)
...
![png](hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_30_0.png)





![png](hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_30_1.png)
...
![png](hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_31_0.png)





![png](hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_31_1.png)
...
![png](hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_32_0.png)
...
![png](hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_33_0.png)
...
![png](hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-kidney_%28renal_cell_carcinoma%29_PYMC_NUMPYRO_lineage-report_35_0.png)
...
```
    ...
    Hostname: compute-a-16-102.o2.rc.hms.harvard.edu
