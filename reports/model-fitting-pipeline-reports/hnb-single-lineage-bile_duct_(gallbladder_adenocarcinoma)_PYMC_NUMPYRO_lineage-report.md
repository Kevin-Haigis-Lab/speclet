...
```python
# Parameters
MODEL_NAME = "hnb-single-lineage-bile_duct_(gallbladder_adenocarcinoma)"
...
```
    ...
    config. name: 'hnb-single-lineage-bile_duct_(gallbladder_adenocarcinoma)'
    ...
    {
        "name": "hnb-single-lineage-bile_duct_(gallbladder_adenocarcinoma)",
        "description": " Single lineage hierarchical negative binomial model for bile_duct_(gallbladder_adenocarcinoma) data. ",
        "active": true,
        "model": "LINEAGE_HIERARCHICAL_NB",
        "data_file": "modeling_data/sublineage-broad-modeling-data/depmap-modeling-data_bile_duct_(gallbladder_adenocarcinoma).csv",
        "model_kwargs": {
            "lineage": "bile_duct_(gallbladder_adenocarcinoma)",
    ...
    Dimensions:                    (chain: 4, draw: 1000, delta_genes_dim_0: 4,
                                    ...
                                    delta_cells_dim_0: 2, delta_cells_dim_1: 6,
                                    cell_chrom: 138, genes_chol_cov_dim_0: 10,
                                    ...
                                    cells_chol_cov_stds_dim_0: 2, cell_line: 6)
    Coordinates: (12/18)
      ...
      * cell_line                  (cell_line) object 'ACH-000141' ... 'ACH-001961'
    ...
    Attributes:
        created_at:           2022-09-29 03:43:27.809938
        arviz_version:        0.12.1
        model_name:           LineageHierNegBinomModel
        model_version:        0.1.3
        model_doc:            A hierarchical negative binomial generalized linear...
        previous_created_at:  ['2022-09-29 03:43:27.809938', '2022-09-28T13:12:38...
    ...
    BFMI: 0.643, 0.622, 0.638, 0.672
    avg. step size: 0.01, 0.009, 0.009, 0.008
    avg. accept prob.: 0.987, 0.987, 0.988, 0.992
...
```
    ...
    [INFO] 2022-09-29 04:23:41 [(lineage_hierarchical_nb.py:data_processing_pipeline:323] Processing data for modeling.
    [INFO] 2022-09-29 04:23:41 [(lineage_hierarchical_nb.py:data_processing_pipeline:324] LFC limits: (-5.0, 5.0)
    [WARNING] 2022-09-29 04:24:56 [(lineage_hierarchical_nb.py:data_processing_pipeline:382] number of data points dropped: 63
    [INFO] 2022-09-29 04:24:56 [(lineage_hierarchical_nb.py:target_gene_is_mutated_vector:630] number of genes mutated in all cells lines: 0
    [INFO] 2022-09-29 04:24:56 [(cancer_gene_mutation_matrix.py:_trim_cancer_genes:77] Dropping 4 cancer genes.
...
![png](hnb-single-lineage-bile_duct_%28gallbladder_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bile_duct_%28gallbladder_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_16_0.png)





![png](hnb-single-lineage-bile_duct_%28gallbladder_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bile_duct_%28gallbladder_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_16_1.png)
...
![png](hnb-single-lineage-bile_duct_%28gallbladder_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bile_duct_%28gallbladder_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_16_3.png)
...
![png](hnb-single-lineage-bile_duct_%28gallbladder_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bile_duct_%28gallbladder_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_18_1.png)
...
![png](hnb-single-lineage-bile_duct_%28gallbladder_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bile_duct_%28gallbladder_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_19_0.png)
...
![png](hnb-single-lineage-bile_duct_%28gallbladder_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bile_duct_%28gallbladder_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_22_1.png)
...
![png](hnb-single-lineage-bile_duct_%28gallbladder_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bile_duct_%28gallbladder_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_22_3.png)
...
![png](hnb-single-lineage-bile_duct_%28gallbladder_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bile_duct_%28gallbladder_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_22_5.png)
...
![png](hnb-single-lineage-bile_duct_%28gallbladder_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bile_duct_%28gallbladder_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_22_7.png)
...
![png](hnb-single-lineage-bile_duct_%28gallbladder_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bile_duct_%28gallbladder_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_22_9.png)
...
![png](hnb-single-lineage-bile_duct_%28gallbladder_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bile_duct_%28gallbladder_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_22_11.png)
...
![png](hnb-single-lineage-bile_duct_%28gallbladder_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bile_duct_%28gallbladder_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_22_13.png)
...
![png](hnb-single-lineage-bile_duct_%28gallbladder_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bile_duct_%28gallbladder_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_24_0.png)
...
![png](hnb-single-lineage-bile_duct_%28gallbladder_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bile_duct_%28gallbladder_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_25_0.png)
...
![png](hnb-single-lineage-bile_duct_%28gallbladder_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bile_duct_%28gallbladder_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_26_0.png)





![png](hnb-single-lineage-bile_duct_%28gallbladder_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bile_duct_%28gallbladder_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_26_1.png)
...
![png](hnb-single-lineage-bile_duct_%28gallbladder_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bile_duct_%28gallbladder_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_28_0.png)
...
![png](hnb-single-lineage-bile_duct_%28gallbladder_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bile_duct_%28gallbladder_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_30_0.png)





![png](hnb-single-lineage-bile_duct_%28gallbladder_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bile_duct_%28gallbladder_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_30_1.png)
...
![png](hnb-single-lineage-bile_duct_%28gallbladder_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bile_duct_%28gallbladder_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_32_0.png)
...
![png](hnb-single-lineage-bile_duct_%28gallbladder_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bile_duct_%28gallbladder_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_33_0.png)
...
![png](hnb-single-lineage-bile_duct_%28gallbladder_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bile_duct_%28gallbladder_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_35_0.png)
...
```
    ...
    Hostname: compute-a-16-68.o2.rc.hms.harvard.edu
