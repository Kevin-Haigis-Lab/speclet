...
```python
# Parameters
MODEL_NAME = "hnb-single-lineage-pancreas"
...
```
    ...
    config. name: 'hnb-single-lineage-pancreas'
    ...
    {
        "name": "hnb-single-lineage-pancreas",
        "description": " Single lineage hierarchical negative binomial model for pancreas data. ",
        "active": true,
        "model": "LINEAGE_HIERARCHICAL_NB",
        "data_file": "modeling_data/sublineage-broad-modeling-data/depmap-modeling-data_pancreas.csv",
        "model_kwargs": {
            "lineage": "pancreas",
    ...
    Dimensions:                    (chain: 4, draw: 1000, delta_genes_dim_0: 8,
                                    ...
                                    delta_cells_dim_0: 2, delta_cells_dim_1: 38,
                                    cell_chrom: 874, genes_chol_cov_dim_0: 36,
                                    ...
                                    cells_chol_cov_stds_dim_0: 2, cell_line: 38)
    Coordinates: (12/19)
      ...
      * cancer_gene                (cancer_gene) object 'KRAS' 'PREX2' ... 'SMAD4'
      ...
      * cell_line                  (cell_line) object 'ACH-000022' ... 'ACH-002039'
    ...
    Attributes:
        created_at:           2022-09-06 11:06:15.507452
        arviz_version:        0.12.1
        model_name:           LineageHierNegBinomModel
        model_version:        0.1.3
        model_doc:            A hierarchical negative binomial generalized linear...
        previous_created_at:  ['2022-09-06 11:06:15.507452', '2022-08-31T16:09:56...
    ...
    BFMI: 0.734, 0.747, 0.704, 0.76
    avg. step size: 0.006, 0.007, 0.007, 0.007
    avg. accept prob.: 0.991, 0.989, 0.989, 0.988
...
```
    ...
    [INFO] 2022-09-07 14:53:16 [(lineage_hierarchical_nb.py:data_processing_pipeline:323] Processing data for modeling.
    [INFO] 2022-09-07 14:53:16 [(lineage_hierarchical_nb.py:data_processing_pipeline:324] LFC limits: (-5.0, 5.0)
    [WARNING] 2022-09-07 14:55:24 [(lineage_hierarchical_nb.py:data_processing_pipeline:382] number of data points dropped: 62
    [INFO] 2022-09-07 14:55:26 [(lineage_hierarchical_nb.py:target_gene_is_mutated_vector:630] number of genes mutated in all cells lines: 0
    [INFO] 2022-09-07 14:55:28 [(cancer_gene_mutation_matrix.py:_trim_cancer_genes:77] Dropping 7 cancer genes.
...
![png](hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_16_0.png)





![png](hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_16_1.png)
...
![png](hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_16_3.png)
...
![png](hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_18_0.png)
...
![png](hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_19_0.png)
...
![png](hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_22_1.png)
...
![png](hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_22_3.png)
...
![png](hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_22_5.png)
...
![png](hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_22_7.png)
...
![png](hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_22_9.png)
...
![png](hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_22_11.png)
...
![png](hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_22_13.png)
...
![png](hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_23_0.png)
...
![png](hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_23_2.png)
...
![png](hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_24_0.png)
...
![png](hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_25_0.png)
...
![png](hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_26_0.png)





![png](hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_26_1.png)
...
![png](hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_28_0.png)
...
![png](hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_30_0.png)





![png](hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_30_1.png)
...
![png](hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_31_0.png)





![png](hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_31_1.png)
...
![png](hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_32_0.png)
...
![png](hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_33_0.png)
...
![png](hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-pancreas_PYMC_NUMPYRO_lineage-report_35_0.png)
