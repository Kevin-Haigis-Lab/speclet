...
```python
# Parameters
MODEL_NAME = "hnb-single-lineage-cervix_(cervical_carcinoma)"
...
```
    ...
    config. name: 'hnb-single-lineage-cervix_(cervical_carcinoma)'
    ...
    {
        "name": "hnb-single-lineage-cervix_(cervical_carcinoma)",
        "description": " Single lineage hierarchical negative binomial model for cervix_(cervical_carcinoma) data. ",
        "active": true,
        "model": "LINEAGE_HIERARCHICAL_NB",
        "data_file": "modeling_data/sublineage-broad-modeling-data/depmap-modeling-data_cervix_(cervical_carcinoma).csv",
        "model_kwargs": {
            "lineage": "cervix_(cervical_carcinoma)",
    ...
    Coordinates: (12/18)
      ...
      * cell_line                  (cell_line) object 'ACH-000556' ... 'ACH-001525'
    ...
    Attributes:
        created_at:           2022-09-21 22:16:00.082447
        arviz_version:        0.12.1
        model_name:           LineageHierNegBinomModel
        model_version:        0.1.3
        model_doc:            A hierarchical negative binomial generalized linear...
        previous_created_at:  ['2022-09-21 22:16:00.082447', '2022-09-19T21:04:10...
    ...
    date created: 2022-09-21 22:16
    sampled 4 chains with (unknown) tuning steps and 1,000 draws
    num. divergences: 0, 0, 0, 0
    percent divergences: 0.0, 0.0, 0.0, 0.0
    BFMI: 0.73, 0.675, 0.664, 0.673
    avg. step size: 0.011, 0.009, 0.008, 0.005
    avg. accept prob.: 0.985, 0.988, 0.987, 0.998
...
```
    ...
    [INFO] 2022-09-21 22:53:09 [(lineage_hierarchical_nb.py:data_processing_pipeline:323] Processing data for modeling.
    [INFO] 2022-09-21 22:53:09 [(lineage_hierarchical_nb.py:data_processing_pipeline:324] LFC limits: (-5.0, 5.0)
    [WARNING] 2022-09-21 22:54:16 [(lineage_hierarchical_nb.py:data_processing_pipeline:382] number of data points dropped: 0
    [INFO] 2022-09-21 22:54:16 [(lineage_hierarchical_nb.py:target_gene_is_mutated_vector:630] number of genes mutated in all cells lines: 0
    [INFO] 2022-09-21 22:54:16 [(cancer_gene_mutation_matrix.py:_trim_cancer_genes:77] Dropping 1 cancer genes.
...
![png](hnb-single-lineage-cervix_%28cervical_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-cervix_%28cervical_carcinoma%29_PYMC_NUMPYRO_lineage-report_16_0.png)





![png](hnb-single-lineage-cervix_%28cervical_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-cervix_%28cervical_carcinoma%29_PYMC_NUMPYRO_lineage-report_16_1.png)
...
![png](hnb-single-lineage-cervix_%28cervical_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-cervix_%28cervical_carcinoma%29_PYMC_NUMPYRO_lineage-report_16_3.png)
...
![png](hnb-single-lineage-cervix_%28cervical_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-cervix_%28cervical_carcinoma%29_PYMC_NUMPYRO_lineage-report_18_1.png)
...
![png](hnb-single-lineage-cervix_%28cervical_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-cervix_%28cervical_carcinoma%29_PYMC_NUMPYRO_lineage-report_19_0.png)
...
![png](hnb-single-lineage-cervix_%28cervical_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-cervix_%28cervical_carcinoma%29_PYMC_NUMPYRO_lineage-report_22_1.png)
...
![png](hnb-single-lineage-cervix_%28cervical_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-cervix_%28cervical_carcinoma%29_PYMC_NUMPYRO_lineage-report_22_3.png)
...
![png](hnb-single-lineage-cervix_%28cervical_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-cervix_%28cervical_carcinoma%29_PYMC_NUMPYRO_lineage-report_22_5.png)
...
![png](hnb-single-lineage-cervix_%28cervical_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-cervix_%28cervical_carcinoma%29_PYMC_NUMPYRO_lineage-report_22_7.png)
...
![png](hnb-single-lineage-cervix_%28cervical_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-cervix_%28cervical_carcinoma%29_PYMC_NUMPYRO_lineage-report_22_9.png)
...
![png](hnb-single-lineage-cervix_%28cervical_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-cervix_%28cervical_carcinoma%29_PYMC_NUMPYRO_lineage-report_22_11.png)
...
![png](hnb-single-lineage-cervix_%28cervical_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-cervix_%28cervical_carcinoma%29_PYMC_NUMPYRO_lineage-report_22_13.png)
...
![png](hnb-single-lineage-cervix_%28cervical_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-cervix_%28cervical_carcinoma%29_PYMC_NUMPYRO_lineage-report_24_0.png)
...
![png](hnb-single-lineage-cervix_%28cervical_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-cervix_%28cervical_carcinoma%29_PYMC_NUMPYRO_lineage-report_25_0.png)
...
![png](hnb-single-lineage-cervix_%28cervical_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-cervix_%28cervical_carcinoma%29_PYMC_NUMPYRO_lineage-report_26_0.png)





![png](hnb-single-lineage-cervix_%28cervical_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-cervix_%28cervical_carcinoma%29_PYMC_NUMPYRO_lineage-report_26_1.png)
...
![png](hnb-single-lineage-cervix_%28cervical_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-cervix_%28cervical_carcinoma%29_PYMC_NUMPYRO_lineage-report_28_0.png)
...
![png](hnb-single-lineage-cervix_%28cervical_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-cervix_%28cervical_carcinoma%29_PYMC_NUMPYRO_lineage-report_30_0.png)





![png](hnb-single-lineage-cervix_%28cervical_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-cervix_%28cervical_carcinoma%29_PYMC_NUMPYRO_lineage-report_30_1.png)
...
![png](hnb-single-lineage-cervix_%28cervical_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-cervix_%28cervical_carcinoma%29_PYMC_NUMPYRO_lineage-report_32_0.png)
...
![png](hnb-single-lineage-cervix_%28cervical_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-cervix_%28cervical_carcinoma%29_PYMC_NUMPYRO_lineage-report_33_0.png)
...
![png](hnb-single-lineage-cervix_%28cervical_carcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-cervix_%28cervical_carcinoma%29_PYMC_NUMPYRO_lineage-report_35_0.png)
...
```
    ...
    Hostname: compute-e-16-239.o2.rc.hms.harvard.edu
