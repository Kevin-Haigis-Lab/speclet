...
```python
# Parameters
MODEL_NAME = "hnb-single-lineage-blood_(ALL)"
...
```
    ...
    config. name: 'hnb-single-lineage-blood_(ALL)'
    ...
    {
        "name": "hnb-single-lineage-blood_(ALL)",
        "description": " Single lineage hierarchical negative binomial model for blood_(ALL) data. ",
        "active": true,
        "model": "LINEAGE_HIERARCHICAL_NB",
        "data_file": "modeling_data/sublineage-broad-modeling-data/depmap-modeling-data_blood_(ALL).csv",
        "model_kwargs": {
            "lineage": "blood_(ALL)",
    ...
    <xarray.Dataset>
    Dimensions:                    (chain: 4, draw: 1000, delta_genes_dim_0: 15,
                                    delta_genes_dim_1: 18119, sgrna: 71062,
                                    delta_cells_dim_0: 2, delta_cells_dim_1: 15,
                                    cell_chrom: 345, genes_chol_cov_dim_0: 120,
                                    cells_chol_cov_dim_0: 3,
                                    genes_chol_cov_corr_dim_0: 15,
                                    genes_chol_cov_corr_dim_1: 15,
                                    genes_chol_cov_stds_dim_0: 15, gene: 18119,
                                    cancer_gene: 11, cells_chol_cov_corr_dim_0: 2,
                                    cells_chol_cov_corr_dim_1: 2,
                                    cells_chol_cov_stds_dim_0: 2, cell_line: 15)
    Coordinates: (12/19)
      * chain                      (chain) int64 0 1 2 3
      * draw                       (draw) int64 0 1 2 3 4 5 ... 995 996 997 998 999
      * delta_genes_dim_0          (delta_genes_dim_0) int64 0 1 2 3 ... 11 12 13 14
      ...
      * cancer_gene                (cancer_gene) object 'BCORL1' ... 'RPL22'
      ...
      * cell_line                  (cell_line) object 'ACH-000070' ... 'ACH-002059'
    ...
    Attributes:
        created_at:           2022-10-01 23:19:55.210422
        arviz_version:        0.12.1
        model_name:           LineageHierNegBinomModel
        model_version:        0.1.3
        model_doc:            A hierarchical negative binomial generalized linear...
        previous_created_at:  ['2022-10-01 23:19:55.210422', '2022-10-02T03:08:12...
    ...
    date created: 2022-10-01 23:19
    sampled 4 chains with (unknown) tuning steps and 1,000 draws
    num. divergences: 0, 0, 0, 0
    percent divergences: 0.0, 0.0, 0.0, 0.0
    BFMI: 0.763, 0.848, 0.71, 0.795
    avg. step size: 0.004, 0.004, 0.003, 0.004
    avg. accept prob.: 0.987, 0.985, 0.992, 0.987
...
```
    ...
    [INFO] 2022-10-02 01:03:10 [(lineage_hierarchical_nb.py:data_processing_pipeline:323] Processing data for modeling.
    [INFO] 2022-10-02 01:03:10 [(lineage_hierarchical_nb.py:data_processing_pipeline:324] LFC limits: (-5.0, 5.0)
    [WARNING] 2022-10-02 01:04:34 [(lineage_hierarchical_nb.py:data_processing_pipeline:382] number of data points dropped: 7
    [INFO] 2022-10-02 01:04:35 [(lineage_hierarchical_nb.py:target_gene_is_mutated_vector:630] number of genes mutated in all cells lines: 0
    [INFO] 2022-10-02 01:04:39 [(cancer_gene_mutation_matrix.py:_trim_cancer_genes:77] Dropping 82 cancer genes.
...
![png](hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_16_0.png)





![png](hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_16_1.png)
...
![png](hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_16_3.png)
...
![png](hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_18_0.png)
...
![png](hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_19_0.png)
...
```
    ...
    ['BCORL1', 'CREBBP', 'CUX1', 'EP300', 'FAT1', 'LRP1B', 'MECOM', 'MN1', 'NRAS', 'PML', 'RPL22']
...
![png](hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_22_1.png)
...
![png](hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_22_3.png)
...
![png](hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_22_5.png)
...
![png](hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_22_7.png)
...
![png](hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_22_9.png)
...
![png](hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_22_11.png)
...
![png](hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_22_13.png)
...
![png](hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_23_0.png)
...
![png](hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_23_2.png)
...
![png](hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_24_0.png)
...
![png](hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_25_0.png)
...
![png](hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_26_0.png)





![png](hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_26_1.png)
...
![png](hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_28_0.png)
...
![png](hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_30_0.png)





![png](hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_30_1.png)
...
![png](hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_31_0.png)





![png](hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_31_1.png)
...
![png](hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_32_0.png)
...
![png](hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_33_0.png)
...
![png](hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28ALL%29_PYMC_NUMPYRO_lineage-report_35_0.png)
