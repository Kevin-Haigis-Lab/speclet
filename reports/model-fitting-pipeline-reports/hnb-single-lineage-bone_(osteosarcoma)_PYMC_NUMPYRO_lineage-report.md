...
```python
# Parameters
MODEL_NAME = "hnb-single-lineage-bone_(osteosarcoma)"
...
```
    ...
    config. name: 'hnb-single-lineage-bone_(osteosarcoma)'
    ...
    {
        "name": "hnb-single-lineage-bone_(osteosarcoma)",
        "description": " Single lineage hierarchical negative binomial model for bone_(osteosarcoma) data. ",
        "active": true,
        "model": "LINEAGE_HIERARCHICAL_NB",
        "data_file": "modeling_data/sublineage-broad-modeling-data/depmap-modeling-data_bone_(osteosarcoma).csv",
        "model_kwargs": {
            "lineage": "bone_(osteosarcoma)",
    ...
    Coordinates: (12/18)
      ...
      * cell_line                  (cell_line) object 'ACH-000082' ... 'ACH-002069'
    ...
    Attributes:
        created_at:           2022-09-29 02:59:55.222332
        arviz_version:        0.12.1
        model_name:           LineageHierNegBinomModel
        model_version:        0.1.3
        model_doc:            A hierarchical negative binomial generalized linear...
        previous_created_at:  ['2022-09-29 02:59:55.222332', '2022-09-28T10:29:01...
    ...
    BFMI: 0.676, 0.726, 0.658, 0.661
    avg. step size: 0.007, 0.009, 0.009, 0.01
    avg. accept prob.: 0.991, 0.988, 0.986, 0.983
...
```
    ...
    [INFO] 2022-09-29 03:47:23 [(lineage_hierarchical_nb.py:data_processing_pipeline:323] Processing data for modeling.
    [INFO] 2022-09-29 03:47:23 [(lineage_hierarchical_nb.py:data_processing_pipeline:324] LFC limits: (-5.0, 5.0)
    [WARNING] 2022-09-29 03:48:43 [(lineage_hierarchical_nb.py:data_processing_pipeline:382] number of data points dropped: 4
    [INFO] 2022-09-29 03:48:44 [(lineage_hierarchical_nb.py:target_gene_is_mutated_vector:630] number of genes mutated in all cells lines: 0
    [INFO] 2022-09-29 03:48:44 [(cancer_gene_mutation_matrix.py:_trim_cancer_genes:77] Dropping 11 cancer genes.
...
![png](hnb-single-lineage-bone_%28osteosarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bone_%28osteosarcoma%29_PYMC_NUMPYRO_lineage-report_16_0.png)





![png](hnb-single-lineage-bone_%28osteosarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bone_%28osteosarcoma%29_PYMC_NUMPYRO_lineage-report_16_1.png)
...
![png](hnb-single-lineage-bone_%28osteosarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bone_%28osteosarcoma%29_PYMC_NUMPYRO_lineage-report_16_3.png)
...
![png](hnb-single-lineage-bone_%28osteosarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bone_%28osteosarcoma%29_PYMC_NUMPYRO_lineage-report_18_1.png)
...
![png](hnb-single-lineage-bone_%28osteosarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bone_%28osteosarcoma%29_PYMC_NUMPYRO_lineage-report_19_0.png)
...
![png](hnb-single-lineage-bone_%28osteosarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bone_%28osteosarcoma%29_PYMC_NUMPYRO_lineage-report_22_1.png)
...
![png](hnb-single-lineage-bone_%28osteosarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bone_%28osteosarcoma%29_PYMC_NUMPYRO_lineage-report_22_3.png)
...
![png](hnb-single-lineage-bone_%28osteosarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bone_%28osteosarcoma%29_PYMC_NUMPYRO_lineage-report_22_5.png)
...
![png](hnb-single-lineage-bone_%28osteosarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bone_%28osteosarcoma%29_PYMC_NUMPYRO_lineage-report_22_7.png)
...
![png](hnb-single-lineage-bone_%28osteosarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bone_%28osteosarcoma%29_PYMC_NUMPYRO_lineage-report_22_9.png)
...
![png](hnb-single-lineage-bone_%28osteosarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bone_%28osteosarcoma%29_PYMC_NUMPYRO_lineage-report_22_11.png)
...
![png](hnb-single-lineage-bone_%28osteosarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bone_%28osteosarcoma%29_PYMC_NUMPYRO_lineage-report_22_13.png)
...
![png](hnb-single-lineage-bone_%28osteosarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bone_%28osteosarcoma%29_PYMC_NUMPYRO_lineage-report_24_0.png)
...
![png](hnb-single-lineage-bone_%28osteosarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bone_%28osteosarcoma%29_PYMC_NUMPYRO_lineage-report_25_0.png)
...
![png](hnb-single-lineage-bone_%28osteosarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bone_%28osteosarcoma%29_PYMC_NUMPYRO_lineage-report_26_0.png)





![png](hnb-single-lineage-bone_%28osteosarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bone_%28osteosarcoma%29_PYMC_NUMPYRO_lineage-report_26_1.png)
...
![png](hnb-single-lineage-bone_%28osteosarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bone_%28osteosarcoma%29_PYMC_NUMPYRO_lineage-report_28_0.png)
...
![png](hnb-single-lineage-bone_%28osteosarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bone_%28osteosarcoma%29_PYMC_NUMPYRO_lineage-report_30_0.png)





![png](hnb-single-lineage-bone_%28osteosarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bone_%28osteosarcoma%29_PYMC_NUMPYRO_lineage-report_30_1.png)
...
![png](hnb-single-lineage-bone_%28osteosarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bone_%28osteosarcoma%29_PYMC_NUMPYRO_lineage-report_32_0.png)
...
![png](hnb-single-lineage-bone_%28osteosarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bone_%28osteosarcoma%29_PYMC_NUMPYRO_lineage-report_33_0.png)
...
![png](hnb-single-lineage-bone_%28osteosarcoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bone_%28osteosarcoma%29_PYMC_NUMPYRO_lineage-report_35_0.png)
