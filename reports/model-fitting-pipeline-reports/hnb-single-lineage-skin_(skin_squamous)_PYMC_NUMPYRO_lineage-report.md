...
```python
# Parameters
MODEL_NAME = "hnb-single-lineage-skin_(skin_squamous)"
...
```
    ...
    config. name: 'hnb-single-lineage-skin_(skin_squamous)'
    ...
    {
        "name": "hnb-single-lineage-skin_(skin_squamous)",
        "description": " Single lineage hierarchical negative binomial model for skin_(skin_squamous) data. ",
        "active": true,
        "model": "LINEAGE_HIERARCHICAL_NB",
        "data_file": "modeling_data/sublineage-broad-modeling-data/depmap-modeling-data_skin_(skin_squamous).csv",
        "model_kwargs": {
            "lineage": "skin_(skin_squamous)",
    ...
    Coordinates: (12/18)
      ...
      * cell_line                  (cell_line) object 'ACH-001328' ... 'ACH-001524'
    ...
    Attributes:
        created_at:           2022-09-06 11:02:25.925820
        arviz_version:        0.12.1
        model_name:           LineageHierNegBinomModel
        model_version:        0.1.3
        model_doc:            A hierarchical negative binomial generalized linear...
        previous_created_at:  ['2022-09-06 11:02:25.925820', '2022-08-29T14:58:10...
    ...
    num. divergences: 0, 0, 2, 0
    percent divergences: 0.0, 0.0, 0.2, 0.0
    BFMI: 0.632, 0.611, 0.642, 0.675
    avg. step size: 0.007, 0.007, 0.007, 0.007
    avg. accept prob.: 0.99, 0.991, 0.983, 0.991
    avg. tree depth: 9.0, 9.0, 8.998, 9.0
...
```
    ...
    [INFO] 2022-09-07 14:56:15 [(lineage_hierarchical_nb.py:data_processing_pipeline:323] Processing data for modeling.
    [INFO] 2022-09-07 14:56:15 [(lineage_hierarchical_nb.py:data_processing_pipeline:324] LFC limits: (-5.0, 5.0)
    [WARNING] 2022-09-07 14:57:34 [(lineage_hierarchical_nb.py:data_processing_pipeline:382] number of data points dropped: 0
    [INFO] 2022-09-07 14:57:34 [(lineage_hierarchical_nb.py:target_gene_is_mutated_vector:630] number of genes mutated in all cells lines: 3
    [INFO] 2022-09-07 14:57:34 [(cancer_gene_mutation_matrix.py:_trim_cancer_genes:77] Dropping 18 cancer genes.
...
![png](hnb-single-lineage-skin_%28skin_squamous%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28skin_squamous%29_PYMC_NUMPYRO_lineage-report_16_0.png)





![png](hnb-single-lineage-skin_%28skin_squamous%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28skin_squamous%29_PYMC_NUMPYRO_lineage-report_16_1.png)
...
![png](hnb-single-lineage-skin_%28skin_squamous%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28skin_squamous%29_PYMC_NUMPYRO_lineage-report_16_3.png)
...
![png](hnb-single-lineage-skin_%28skin_squamous%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28skin_squamous%29_PYMC_NUMPYRO_lineage-report_18_1.png)
...
![png](hnb-single-lineage-skin_%28skin_squamous%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28skin_squamous%29_PYMC_NUMPYRO_lineage-report_19_0.png)
...
![png](hnb-single-lineage-skin_%28skin_squamous%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28skin_squamous%29_PYMC_NUMPYRO_lineage-report_22_1.png)
...
![png](hnb-single-lineage-skin_%28skin_squamous%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28skin_squamous%29_PYMC_NUMPYRO_lineage-report_22_3.png)
...
![png](hnb-single-lineage-skin_%28skin_squamous%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28skin_squamous%29_PYMC_NUMPYRO_lineage-report_22_5.png)
...
![png](hnb-single-lineage-skin_%28skin_squamous%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28skin_squamous%29_PYMC_NUMPYRO_lineage-report_22_7.png)
...
![png](hnb-single-lineage-skin_%28skin_squamous%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28skin_squamous%29_PYMC_NUMPYRO_lineage-report_22_9.png)
...
![png](hnb-single-lineage-skin_%28skin_squamous%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28skin_squamous%29_PYMC_NUMPYRO_lineage-report_22_11.png)
...
![png](hnb-single-lineage-skin_%28skin_squamous%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28skin_squamous%29_PYMC_NUMPYRO_lineage-report_22_13.png)
...
![png](hnb-single-lineage-skin_%28skin_squamous%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28skin_squamous%29_PYMC_NUMPYRO_lineage-report_24_0.png)
...
![png](hnb-single-lineage-skin_%28skin_squamous%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28skin_squamous%29_PYMC_NUMPYRO_lineage-report_25_0.png)
...
![png](hnb-single-lineage-skin_%28skin_squamous%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28skin_squamous%29_PYMC_NUMPYRO_lineage-report_26_0.png)





![png](hnb-single-lineage-skin_%28skin_squamous%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28skin_squamous%29_PYMC_NUMPYRO_lineage-report_26_1.png)
...
![png](hnb-single-lineage-skin_%28skin_squamous%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28skin_squamous%29_PYMC_NUMPYRO_lineage-report_28_0.png)
...
![png](hnb-single-lineage-skin_%28skin_squamous%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28skin_squamous%29_PYMC_NUMPYRO_lineage-report_30_0.png)





![png](hnb-single-lineage-skin_%28skin_squamous%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28skin_squamous%29_PYMC_NUMPYRO_lineage-report_30_1.png)
...
![png](hnb-single-lineage-skin_%28skin_squamous%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28skin_squamous%29_PYMC_NUMPYRO_lineage-report_32_0.png)
...
![png](hnb-single-lineage-skin_%28skin_squamous%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28skin_squamous%29_PYMC_NUMPYRO_lineage-report_33_0.png)
...
![png](hnb-single-lineage-skin_%28skin_squamous%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-skin_%28skin_squamous%29_PYMC_NUMPYRO_lineage-report_35_0.png)
...
```
    ...
    Hostname: compute-a-17-65.o2.rc.hms.harvard.edu
