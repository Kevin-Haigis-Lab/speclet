...
```python
# Parameters
MODEL_NAME = "hnb-single-lineage-ovary_(ovary_adenocarcinoma)"
...
```
    ...
    config. name: 'hnb-single-lineage-ovary_(ovary_adenocarcinoma)'
    ...
    {
        "name": "hnb-single-lineage-ovary_(ovary_adenocarcinoma)",
        "description": " Single lineage hierarchical negative binomial model for ovary_(ovary_adenocarcinoma) data. ",
        "active": true,
        "model": "LINEAGE_HIERARCHICAL_NB",
        "data_file": "modeling_data/sublineage-broad-modeling-data/depmap-modeling-data_ovary_(ovary_adenocarcinoma).csv",
        "model_kwargs": {
            "lineage": "ovary_(ovary_adenocarcinoma)",
    ...
    Dimensions:                    (chain: 4, draw: 1000, delta_genes_dim_0: 10,
                                    ...
                                    delta_cells_dim_0: 2, delta_cells_dim_1: 42,
                                    cell_chrom: 966, genes_chol_cov_dim_0: 55,
                                    ...
                                    cells_chol_cov_stds_dim_0: 2, cell_line: 42)
    Coordinates: (12/19)
      ...
      * cancer_gene                (cancer_gene) object 'BRCA1' ... 'SMARCA4'
      ...
      * cell_line                  (cell_line) object 'ACH-000013' ... 'ACH-001991'
    ...
    Attributes:
        created_at:           2022-09-29 02:42:53.393264
        arviz_version:        0.12.1
        model_name:           LineageHierNegBinomModel
        model_version:        0.1.3
        model_doc:            A hierarchical negative binomial generalized linear...
        previous_created_at:  ['2022-09-29 02:42:53.393264', '2022-09-28T20:38:07...
    ...
    date created: 2022-09-29 02:42
    sampled 4 chains with (unknown) tuning steps and 1,000 draws
    num. divergences: 0, 0, 0, 0
    percent divergences: 0.0, 0.0, 0.0, 0.0
    BFMI: 0.771, 0.698, 0.665, 0.796
    avg. step size: 0.008, 0.008, 0.008, 0.009
    avg. accept prob.: 0.987, 0.988, 0.988, 0.982
...
```
    ...
    [INFO] 2022-09-29 06:37:45 [(lineage_hierarchical_nb.py:data_processing_pipeline:323] Processing data for modeling.
    [INFO] 2022-09-29 06:37:45 [(lineage_hierarchical_nb.py:data_processing_pipeline:324] LFC limits: (-5.0, 5.0)
    [WARNING] 2022-09-29 06:40:09 [(lineage_hierarchical_nb.py:data_processing_pipeline:382] number of data points dropped: 31
    [INFO] 2022-09-29 06:40:12 [(lineage_hierarchical_nb.py:target_gene_is_mutated_vector:630] number of genes mutated in all cells lines: 0
    [INFO] 2022-09-29 06:40:15 [(cancer_gene_mutation_matrix.py:_trim_cancer_genes:77] Dropping 9 cancer genes.
...
![png](hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_16_0.png)





![png](hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_16_1.png)
...
![png](hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_16_3.png)
...
![png](hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_18_0.png)
...
![png](hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_19_0.png)
...
```
    ...
    ['BRCA1', 'BRCA2', 'CTNNB1', 'LRP1B', 'PIK3R1', 'SMARCA4']
...
![png](hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_22_1.png)
...
![png](hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_22_3.png)
...
![png](hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_22_5.png)
...
![png](hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_22_7.png)
...
![png](hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_22_9.png)
...
![png](hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_22_11.png)
...
![png](hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_22_13.png)
...
![png](hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_23_0.png)
...
![png](hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_23_2.png)
...
![png](hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_24_0.png)
...
![png](hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_25_0.png)
...
![png](hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_26_0.png)





![png](hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_26_1.png)
...
![png](hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_28_0.png)
...
![png](hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_30_0.png)





![png](hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_30_1.png)
...
![png](hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_31_0.png)





![png](hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_31_1.png)
...
![png](hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_32_0.png)
...
![png](hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_33_0.png)
...
![png](hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-ovary_%28ovary_adenocarcinoma%29_PYMC_NUMPYRO_lineage-report_35_0.png)
...
```
    ...
    Hostname: compute-a-16-39.o2.rc.hms.harvard.edu
