...
```python
# Parameters
MODEL_NAME = "hnb-single-lineage-plasma_cell_(multiple_myeloma)"
...
```
    ...
    config. name: 'hnb-single-lineage-plasma_cell_(multiple_myeloma)'
    ...
    {
        "name": "hnb-single-lineage-plasma_cell_(multiple_myeloma)",
        "description": " Single lineage hierarchical negative binomial model for plasma_cell_(multiple_myeloma) data. ",
        "active": true,
        "model": "LINEAGE_HIERARCHICAL_NB",
        "data_file": "modeling_data/sublineage-broad-modeling-data/depmap-modeling-data_plasma_cell_(multiple_myeloma).csv",
        "model_kwargs": {
            "lineage": "plasma_cell_(multiple_myeloma)",
    ...
    Dimensions:                    (chain: 4, draw: 1000, delta_genes_dim_0: 4,
                                    ...
                                    delta_cells_dim_0: 2, delta_cells_dim_1: 21,
                                    cell_chrom: 483, genes_chol_cov_dim_0: 10,
                                    ...
                                    cells_chol_cov_stds_dim_0: 2, cell_line: 21)
    Coordinates: (12/18)
      ...
      * cell_line                  (cell_line) object 'ACH-000024' ... 'ACH-000889'
    ...
    Attributes:
        created_at:           2022-09-21 23:03:07.364344
        arviz_version:        0.12.1
        model_name:           LineageHierNegBinomModel
        model_version:        0.1.3
        model_doc:            A hierarchical negative binomial generalized linear...
        previous_created_at:  ['2022-09-21 23:03:07.364344', '2022-09-19T18:00:44...
    ...
    date created: 2022-09-21 23:03
    sampled 4 chains with (unknown) tuning steps and 1,000 draws
    num. divergences: 0, 0, 0, 0
    percent divergences: 0.0, 0.0, 0.0, 0.0
    BFMI: 0.653, 0.662, 0.701, 0.75
    avg. step size: 0.008, 0.008, 0.008, 0.009
    avg. accept prob.: 0.989, 0.989, 0.99, 0.988
...
```
    ...
    [INFO] 2022-09-22 00:31:39 [(lineage_hierarchical_nb.py:data_processing_pipeline:323] Processing data for modeling.
    [INFO] 2022-09-22 00:31:39 [(lineage_hierarchical_nb.py:data_processing_pipeline:324] LFC limits: (-5.0, 5.0)
    [WARNING] 2022-09-22 00:33:22 [(lineage_hierarchical_nb.py:data_processing_pipeline:382] number of data points dropped: 10
    [INFO] 2022-09-22 00:33:24 [(lineage_hierarchical_nb.py:target_gene_is_mutated_vector:630] number of genes mutated in all cells lines: 0
    [INFO] 2022-09-22 00:33:24 [(cancer_gene_mutation_matrix.py:_trim_cancer_genes:77] Dropping 1 cancer genes.
...
![png](hnb-single-lineage-plasma_cell_%28multiple_myeloma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-plasma_cell_%28multiple_myeloma%29_PYMC_NUMPYRO_lineage-report_16_0.png)





![png](hnb-single-lineage-plasma_cell_%28multiple_myeloma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-plasma_cell_%28multiple_myeloma%29_PYMC_NUMPYRO_lineage-report_16_1.png)
...
![png](hnb-single-lineage-plasma_cell_%28multiple_myeloma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-plasma_cell_%28multiple_myeloma%29_PYMC_NUMPYRO_lineage-report_16_3.png)
...
![png](hnb-single-lineage-plasma_cell_%28multiple_myeloma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-plasma_cell_%28multiple_myeloma%29_PYMC_NUMPYRO_lineage-report_18_1.png)
...
![png](hnb-single-lineage-plasma_cell_%28multiple_myeloma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-plasma_cell_%28multiple_myeloma%29_PYMC_NUMPYRO_lineage-report_19_0.png)
...
![png](hnb-single-lineage-plasma_cell_%28multiple_myeloma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-plasma_cell_%28multiple_myeloma%29_PYMC_NUMPYRO_lineage-report_22_1.png)
...
![png](hnb-single-lineage-plasma_cell_%28multiple_myeloma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-plasma_cell_%28multiple_myeloma%29_PYMC_NUMPYRO_lineage-report_22_3.png)
...
![png](hnb-single-lineage-plasma_cell_%28multiple_myeloma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-plasma_cell_%28multiple_myeloma%29_PYMC_NUMPYRO_lineage-report_22_5.png)
...
![png](hnb-single-lineage-plasma_cell_%28multiple_myeloma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-plasma_cell_%28multiple_myeloma%29_PYMC_NUMPYRO_lineage-report_22_7.png)
...
![png](hnb-single-lineage-plasma_cell_%28multiple_myeloma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-plasma_cell_%28multiple_myeloma%29_PYMC_NUMPYRO_lineage-report_22_9.png)
...
![png](hnb-single-lineage-plasma_cell_%28multiple_myeloma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-plasma_cell_%28multiple_myeloma%29_PYMC_NUMPYRO_lineage-report_22_11.png)
...
![png](hnb-single-lineage-plasma_cell_%28multiple_myeloma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-plasma_cell_%28multiple_myeloma%29_PYMC_NUMPYRO_lineage-report_22_13.png)
...
![png](hnb-single-lineage-plasma_cell_%28multiple_myeloma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-plasma_cell_%28multiple_myeloma%29_PYMC_NUMPYRO_lineage-report_24_0.png)
...
![png](hnb-single-lineage-plasma_cell_%28multiple_myeloma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-plasma_cell_%28multiple_myeloma%29_PYMC_NUMPYRO_lineage-report_25_0.png)
...
![png](hnb-single-lineage-plasma_cell_%28multiple_myeloma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-plasma_cell_%28multiple_myeloma%29_PYMC_NUMPYRO_lineage-report_26_0.png)





![png](hnb-single-lineage-plasma_cell_%28multiple_myeloma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-plasma_cell_%28multiple_myeloma%29_PYMC_NUMPYRO_lineage-report_26_1.png)
...
![png](hnb-single-lineage-plasma_cell_%28multiple_myeloma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-plasma_cell_%28multiple_myeloma%29_PYMC_NUMPYRO_lineage-report_28_0.png)
...
![png](hnb-single-lineage-plasma_cell_%28multiple_myeloma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-plasma_cell_%28multiple_myeloma%29_PYMC_NUMPYRO_lineage-report_30_0.png)





![png](hnb-single-lineage-plasma_cell_%28multiple_myeloma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-plasma_cell_%28multiple_myeloma%29_PYMC_NUMPYRO_lineage-report_30_1.png)
...
![png](hnb-single-lineage-plasma_cell_%28multiple_myeloma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-plasma_cell_%28multiple_myeloma%29_PYMC_NUMPYRO_lineage-report_32_0.png)
...
![png](hnb-single-lineage-plasma_cell_%28multiple_myeloma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-plasma_cell_%28multiple_myeloma%29_PYMC_NUMPYRO_lineage-report_33_0.png)
...
![png](hnb-single-lineage-plasma_cell_%28multiple_myeloma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-plasma_cell_%28multiple_myeloma%29_PYMC_NUMPYRO_lineage-report_35_0.png)
...
```
    ...
    Hostname: compute-f-17-12.o2.rc.hms.harvard.edu
