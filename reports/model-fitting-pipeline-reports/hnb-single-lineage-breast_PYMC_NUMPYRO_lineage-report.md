...
```python
# Parameters
MODEL_NAME = "hnb-single-lineage-breast"
...
```
    ...
    config. name: 'hnb-single-lineage-breast'
    ...
    {
        "name": "hnb-single-lineage-breast",
        "description": " Single lineage hierarchical negative binomial model for breast data. ",
        "active": true,
        "model": "LINEAGE_HIERARCHICAL_NB",
        "data_file": "modeling_data/sublineage-broad-modeling-data/depmap-modeling-data_breast.csv",
        "model_kwargs": {
            "lineage": "breast",
    ...
    Dimensions:                    (chain: 4, draw: 1000, delta_genes_dim_0: 6,
                                    ...
                                    cell_chrom: 874, genes_chol_cov_dim_0: 21,
    ...
    Coordinates: (12/19)
      ...
      * cancer_gene                (cancer_gene) object 'BRCA2' 'PIK3CA'
      ...
      * cell_line                  (cell_line) object 'ACH-000017' ... 'ACH-001819'
    ...
    Attributes:
        created_at:           2022-09-06 11:05:02.665180
        arviz_version:        0.12.1
        model_name:           LineageHierNegBinomModel
        model_version:        0.1.3
        model_doc:            A hierarchical negative binomial generalized linear...
        previous_created_at:  ['2022-09-06 11:05:02.665180', '2022-09-06T05:01:53...
    ...
    BFMI: 0.662, 0.745, 0.698, 0.768
    avg. step size: 0.008, 0.009, 0.008, 0.009
    avg. accept prob.: 0.99, 0.987, 0.99, 0.987
    avg. tree depth: 9.0, 9.0, 9.01, 9.0
...
```
    ...
    [INFO] 2022-09-07 14:53:14 [(lineage_hierarchical_nb.py:data_processing_pipeline:323] Processing data for modeling.
    [INFO] 2022-09-07 14:53:14 [(lineage_hierarchical_nb.py:data_processing_pipeline:324] LFC limits: (-5.0, 5.0)
    [WARNING] 2022-09-07 14:55:21 [(lineage_hierarchical_nb.py:data_processing_pipeline:382] number of data points dropped: 71159
    [INFO] 2022-09-07 14:55:24 [(lineage_hierarchical_nb.py:target_gene_is_mutated_vector:630] number of genes mutated in all cells lines: 0
    [INFO] 2022-09-07 14:55:26 [(cancer_gene_mutation_matrix.py:_trim_cancer_genes:77] Dropping 15 cancer genes.
...
![png](hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_16_0.png)





![png](hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_16_1.png)
...
![png](hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_16_3.png)
...
![png](hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_18_0.png)
...
![png](hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_19_0.png)
...
![png](hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_22_1.png)
...
![png](hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_22_3.png)
...
![png](hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_22_5.png)
...
![png](hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_22_7.png)
...
![png](hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_22_9.png)
...
![png](hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_22_11.png)
...
![png](hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_22_13.png)
...
![png](hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_23_0.png)





![png](hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_23_1.png)
...
![png](hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_24_0.png)
...
![png](hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_25_0.png)
...
![png](hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_26_0.png)





![png](hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_26_1.png)
...
![png](hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_28_0.png)
...
![png](hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_30_0.png)





![png](hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_30_1.png)
...
![png](hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_31_0.png)





![png](hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_31_1.png)
...
![png](hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_32_0.png)
...
![png](hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_33_0.png)
...
![png](hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-breast_PYMC_NUMPYRO_lineage-report_35_0.png)
