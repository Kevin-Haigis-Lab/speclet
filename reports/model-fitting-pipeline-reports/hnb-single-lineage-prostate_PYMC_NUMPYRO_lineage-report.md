...
```
    ...
    config. name: 'hnb-single-lineage-prostate'
    ...
    {
        "name": "hnb-single-lineage-prostate",
        "description": " Single lineage hierarchical negative binomial model for prostate data. ",
        "active": true,
        "model": "LINEAGE_HIERARCHICAL_NB",
        "data_file": "modeling_data/sublineage-broad-modeling-data/depmap-modeling-data_prostate.csv",
        "model_kwargs": {
            "lineage": "prostate",
    ...
    Attributes:
        created_at:           2022-09-06 11:02:21.530509
        arviz_version:        0.12.1
        model_name:           LineageHierNegBinomModel
        model_version:        0.1.3
        model_doc:            A hierarchical negative binomial generalized linear...
        previous_created_at:  ['2022-09-06 11:02:21.530509', '2022-08-31T04:02:16...
    ...
    BFMI: 0.699, 0.634, 0.697, 0.653
    avg. step size: 0.007, 0.008, 0.007, 0.007
    avg. accept prob.: 0.988, 0.987, 0.987, 0.988
...
```
    ...
    [INFO] 2022-09-07 15:06:16 [(lineage_hierarchical_nb.py:data_processing_pipeline:323] Processing data for modeling.
    [INFO] 2022-09-07 15:06:16 [(lineage_hierarchical_nb.py:data_processing_pipeline:324] LFC limits: (-5.0, 5.0)
    [WARNING] 2022-09-07 15:07:29 [(lineage_hierarchical_nb.py:data_processing_pipeline:382] number of data points dropped: 2
    [INFO] 2022-09-07 15:07:30 [(lineage_hierarchical_nb.py:target_gene_is_mutated_vector:630] number of genes mutated in all cells lines: 0
    [INFO] 2022-09-07 15:07:30 [(cancer_gene_mutation_matrix.py:_trim_cancer_genes:77] Dropping 9 cancer genes.
...
![png](hnb-single-lineage-prostate_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-prostate_PYMC_NUMPYRO_lineage-report_16_0.png)





![png](hnb-single-lineage-prostate_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-prostate_PYMC_NUMPYRO_lineage-report_16_1.png)
...
![png](hnb-single-lineage-prostate_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-prostate_PYMC_NUMPYRO_lineage-report_16_3.png)
...
![png](hnb-single-lineage-prostate_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-prostate_PYMC_NUMPYRO_lineage-report_18_1.png)
...
![png](hnb-single-lineage-prostate_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-prostate_PYMC_NUMPYRO_lineage-report_19_0.png)
...
![png](hnb-single-lineage-prostate_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-prostate_PYMC_NUMPYRO_lineage-report_22_1.png)
...
![png](hnb-single-lineage-prostate_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-prostate_PYMC_NUMPYRO_lineage-report_22_3.png)
...
![png](hnb-single-lineage-prostate_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-prostate_PYMC_NUMPYRO_lineage-report_22_5.png)
...
![png](hnb-single-lineage-prostate_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-prostate_PYMC_NUMPYRO_lineage-report_22_7.png)
...
![png](hnb-single-lineage-prostate_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-prostate_PYMC_NUMPYRO_lineage-report_22_9.png)
...
![png](hnb-single-lineage-prostate_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-prostate_PYMC_NUMPYRO_lineage-report_22_11.png)
...
![png](hnb-single-lineage-prostate_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-prostate_PYMC_NUMPYRO_lineage-report_22_13.png)
...
![png](hnb-single-lineage-prostate_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-prostate_PYMC_NUMPYRO_lineage-report_24_0.png)
...
![png](hnb-single-lineage-prostate_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-prostate_PYMC_NUMPYRO_lineage-report_25_0.png)
...
![png](hnb-single-lineage-prostate_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-prostate_PYMC_NUMPYRO_lineage-report_26_0.png)





![png](hnb-single-lineage-prostate_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-prostate_PYMC_NUMPYRO_lineage-report_26_1.png)
...
![png](hnb-single-lineage-prostate_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-prostate_PYMC_NUMPYRO_lineage-report_28_0.png)
...
![png](hnb-single-lineage-prostate_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-prostate_PYMC_NUMPYRO_lineage-report_30_0.png)





![png](hnb-single-lineage-prostate_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-prostate_PYMC_NUMPYRO_lineage-report_30_1.png)
...
![png](hnb-single-lineage-prostate_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-prostate_PYMC_NUMPYRO_lineage-report_32_0.png)
...
![png](hnb-single-lineage-prostate_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-prostate_PYMC_NUMPYRO_lineage-report_33_0.png)
...
![png](hnb-single-lineage-prostate_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-prostate_PYMC_NUMPYRO_lineage-report_35_0.png)
...
```
    ...
    Hostname: compute-a-16-115.o2.rc.hms.harvard.edu
