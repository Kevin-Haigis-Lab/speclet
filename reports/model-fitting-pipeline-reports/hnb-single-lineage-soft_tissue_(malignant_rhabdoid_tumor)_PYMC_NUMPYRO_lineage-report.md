...
```python
# Parameters
MODEL_NAME = "hnb-single-lineage-soft_tissue_(malignant_rhabdoid_tumor)"
...
```
    ...
    config. name: 'hnb-single-lineage-soft_tissue_(malignant_rhabdoid_tumor)'
    ...
    {
        "name": "hnb-single-lineage-soft_tissue_(malignant_rhabdoid_tumor)",
        "description": " Single lineage hierarchical negative binomial model for soft_tissue_(malignant_rhabdoid_tumor) data. ",
        "active": true,
        "model": "LINEAGE_HIERARCHICAL_NB",
        "data_file": "modeling_data/sublineage-broad-modeling-data/depmap-modeling-data_soft_tissue_(malignant_rhabdoid_tumor).csv",
        "model_kwargs": {
            "lineage": "soft_tissue_(malignant_rhabdoid_tumor)",
    ...
    Dimensions:                    (chain: 4, draw: 1000, delta_genes_dim_0: 4,
                                    ...
                                    delta_cells_dim_0: 2, delta_cells_dim_1: 8,
                                    cell_chrom: 184, genes_chol_cov_dim_0: 10,
                                    ...
                                    cells_chol_cov_stds_dim_0: 2, cell_line: 8)
    Coordinates: (12/18)
      ...
      * cell_line                  (cell_line) object 'ACH-000172' ... 'ACH-001212'
    ...
    Attributes:
        created_at:           2022-09-21 23:56:37.111221
        arviz_version:        0.12.1
        model_name:           LineageHierNegBinomModel
        model_version:        0.1.3
        model_doc:            A hierarchical negative binomial generalized linear...
        previous_created_at:  ['2022-09-21 23:56:37.111221', '2022-09-20T04:34:00...
    ...
    date created: 2022-09-21 23:56
    sampled 4 chains with (unknown) tuning steps and 1,000 draws
    num. divergences: 0, 0, 0, 0
    percent divergences: 0.0, 0.0, 0.0, 0.0
    BFMI: 0.779, 0.726, 0.678, 0.679
    avg. step size: 0.011, 0.012, 0.012, 0.01
    avg. accept prob.: 0.986, 0.983, 0.983, 0.981
    avg. tree depth: 9.0, 9.0, 10.0, 9.0
...
```
    ...
    [INFO] 2022-09-22 00:42:07 [(lineage_hierarchical_nb.py:data_processing_pipeline:323] Processing data for modeling.
    [INFO] 2022-09-22 00:42:07 [(lineage_hierarchical_nb.py:data_processing_pipeline:324] LFC limits: (-5.0, 5.0)
    [WARNING] 2022-09-22 00:43:21 [(lineage_hierarchical_nb.py:data_processing_pipeline:382] number of data points dropped: 2
    [INFO] 2022-09-22 00:43:22 [(lineage_hierarchical_nb.py:target_gene_is_mutated_vector:630] number of genes mutated in all cells lines: 0
    [INFO] 2022-09-22 00:43:22 [(cancer_gene_mutation_matrix.py:_trim_cancer_genes:77] Dropping 2 cancer genes.
...
![png](hnb-single-lineage-soft_tissue_%28malignant_rhabdoid_tumor%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28malignant_rhabdoid_tumor%29_PYMC_NUMPYRO_lineage-report_16_0.png)





![png](hnb-single-lineage-soft_tissue_%28malignant_rhabdoid_tumor%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28malignant_rhabdoid_tumor%29_PYMC_NUMPYRO_lineage-report_16_1.png)
...
![png](hnb-single-lineage-soft_tissue_%28malignant_rhabdoid_tumor%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28malignant_rhabdoid_tumor%29_PYMC_NUMPYRO_lineage-report_16_3.png)
...
![png](hnb-single-lineage-soft_tissue_%28malignant_rhabdoid_tumor%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28malignant_rhabdoid_tumor%29_PYMC_NUMPYRO_lineage-report_18_1.png)
...
![png](hnb-single-lineage-soft_tissue_%28malignant_rhabdoid_tumor%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28malignant_rhabdoid_tumor%29_PYMC_NUMPYRO_lineage-report_19_0.png)
...
![png](hnb-single-lineage-soft_tissue_%28malignant_rhabdoid_tumor%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28malignant_rhabdoid_tumor%29_PYMC_NUMPYRO_lineage-report_22_1.png)
...
![png](hnb-single-lineage-soft_tissue_%28malignant_rhabdoid_tumor%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28malignant_rhabdoid_tumor%29_PYMC_NUMPYRO_lineage-report_22_3.png)
...
![png](hnb-single-lineage-soft_tissue_%28malignant_rhabdoid_tumor%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28malignant_rhabdoid_tumor%29_PYMC_NUMPYRO_lineage-report_22_5.png)
...
![png](hnb-single-lineage-soft_tissue_%28malignant_rhabdoid_tumor%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28malignant_rhabdoid_tumor%29_PYMC_NUMPYRO_lineage-report_22_7.png)
...
![png](hnb-single-lineage-soft_tissue_%28malignant_rhabdoid_tumor%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28malignant_rhabdoid_tumor%29_PYMC_NUMPYRO_lineage-report_22_9.png)
...
![png](hnb-single-lineage-soft_tissue_%28malignant_rhabdoid_tumor%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28malignant_rhabdoid_tumor%29_PYMC_NUMPYRO_lineage-report_22_11.png)
...
![png](hnb-single-lineage-soft_tissue_%28malignant_rhabdoid_tumor%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28malignant_rhabdoid_tumor%29_PYMC_NUMPYRO_lineage-report_22_13.png)
...
![png](hnb-single-lineage-soft_tissue_%28malignant_rhabdoid_tumor%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28malignant_rhabdoid_tumor%29_PYMC_NUMPYRO_lineage-report_24_0.png)
...
![png](hnb-single-lineage-soft_tissue_%28malignant_rhabdoid_tumor%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28malignant_rhabdoid_tumor%29_PYMC_NUMPYRO_lineage-report_25_0.png)
...
![png](hnb-single-lineage-soft_tissue_%28malignant_rhabdoid_tumor%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28malignant_rhabdoid_tumor%29_PYMC_NUMPYRO_lineage-report_26_0.png)





![png](hnb-single-lineage-soft_tissue_%28malignant_rhabdoid_tumor%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28malignant_rhabdoid_tumor%29_PYMC_NUMPYRO_lineage-report_26_1.png)
...
![png](hnb-single-lineage-soft_tissue_%28malignant_rhabdoid_tumor%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28malignant_rhabdoid_tumor%29_PYMC_NUMPYRO_lineage-report_28_0.png)
...
![png](hnb-single-lineage-soft_tissue_%28malignant_rhabdoid_tumor%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28malignant_rhabdoid_tumor%29_PYMC_NUMPYRO_lineage-report_30_0.png)





![png](hnb-single-lineage-soft_tissue_%28malignant_rhabdoid_tumor%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28malignant_rhabdoid_tumor%29_PYMC_NUMPYRO_lineage-report_30_1.png)
...
![png](hnb-single-lineage-soft_tissue_%28malignant_rhabdoid_tumor%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28malignant_rhabdoid_tumor%29_PYMC_NUMPYRO_lineage-report_32_0.png)
...
![png](hnb-single-lineage-soft_tissue_%28malignant_rhabdoid_tumor%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28malignant_rhabdoid_tumor%29_PYMC_NUMPYRO_lineage-report_33_0.png)
...
![png](hnb-single-lineage-soft_tissue_%28malignant_rhabdoid_tumor%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-soft_tissue_%28malignant_rhabdoid_tumor%29_PYMC_NUMPYRO_lineage-report_35_0.png)
...
```
    ...
    Hostname: compute-e-16-241.o2.rc.hms.harvard.edu
