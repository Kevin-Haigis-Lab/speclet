...
```
    ...
    config. name: 'hnb-single-lineage-urinary_tract'
    ...
    {
        "name": "hnb-single-lineage-urinary_tract",
        "description": " Single lineage hierarchical negative binomial model for urinary_tract data. ",
        "active": true,
        "model": "LINEAGE_HIERARCHICAL_NB",
        "data_file": "modeling_data/sublineage-broad-modeling-data/depmap-modeling-data_urinary_tract.csv",
        "model_kwargs": {
            "lineage": "urinary_tract",
    ...
    Dimensions:                    (chain: 4, draw: 1000, delta_genes_dim_0: 6,
                                    ...
                                    delta_cells_dim_0: 2, delta_cells_dim_1: 30,
                                    cell_chrom: 690, genes_chol_cov_dim_0: 21,
                                    ...
                                    cells_chol_cov_stds_dim_0: 2, cell_line: 30)
    Coordinates: (12/19)
      ...
      * cancer_gene                (cancer_gene) object 'FGFR3' 'KDM6A'
      ...
      * cell_line                  (cell_line) object 'ACH-000011' ... 'ACH-001416'
    ...
    Attributes:
        created_at:           2022-09-28 06:39:11.324534
        arviz_version:        0.12.1
        model_name:           LineageHierNegBinomModel
        model_version:        0.1.3
        model_doc:            A hierarchical negative binomial generalized linear...
        previous_created_at:  ['2022-09-28 06:39:11.324534', '2022-09-28T10:25:14...
    ...
    date created: 2022-09-28 06:39
    sampled 4 chains with (unknown) tuning steps and 1,000 draws
    num. divergences: 0, 0, 0, 0
    percent divergences: 0.0, 0.0, 0.0, 0.0
    BFMI: 0.694, 0.644, 0.711, 0.728
    avg. step size: 0.008, 0.008, 0.008, 0.008
    avg. accept prob.: 0.988, 0.987, 0.989, 0.989
...
```
    ...
    [INFO] 2022-09-28 08:33:56 [(lineage_hierarchical_nb.py:data_processing_pipeline:323] Processing data for modeling.
    [INFO] 2022-09-28 08:33:56 [(lineage_hierarchical_nb.py:data_processing_pipeline:324] LFC limits: (-5.0, 5.0)
    [WARNING] 2022-09-28 08:35:57 [(lineage_hierarchical_nb.py:data_processing_pipeline:382] number of data points dropped: 25
    [INFO] 2022-09-28 08:36:00 [(lineage_hierarchical_nb.py:target_gene_is_mutated_vector:630] number of genes mutated in all cells lines: 0
    [INFO] 2022-09-28 08:36:01 [(cancer_gene_mutation_matrix.py:_trim_cancer_genes:77] Dropping 8 cancer genes.
...
![png](hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_16_0.png)





![png](hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_16_1.png)
...
![png](hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_16_3.png)
...
![png](hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_18_0.png)
...
![png](hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_19_0.png)
...
![png](hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_22_1.png)
...
![png](hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_22_3.png)
...
![png](hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_22_5.png)
...
![png](hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_22_7.png)
...
![png](hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_22_9.png)
...
![png](hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_22_11.png)
...
![png](hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_22_13.png)
...
![png](hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_23_0.png)





![png](hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_23_1.png)
...
![png](hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_24_0.png)
...
![png](hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_25_0.png)
...
![png](hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_26_0.png)





![png](hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_26_1.png)
...
![png](hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_28_0.png)
...
![png](hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_30_0.png)





![png](hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_30_1.png)
...
![png](hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_31_0.png)





![png](hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_31_1.png)
...
![png](hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_32_0.png)
...
![png](hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_33_0.png)
...
![png](hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-urinary_tract_PYMC_NUMPYRO_lineage-report_35_0.png)
