...
```python
# Parameters
MODEL_NAME = "hnb-single-lineage-bile_duct_(cholangiocarcinoma)"
...
```
    ...
    config. name: 'hnb-single-lineage-bile_duct_(cholangiocarcinoma)'
    ...
    {
        "name": "hnb-single-lineage-bile_duct_(cholangiocarcinoma)",
        "description": " Single lineage hierarchical negative binomial model for bile_duct_(cholangiocarcinoma) data. ",
        "active": true,
        "model": "LINEAGE_HIERARCHICAL_NB",
        "data_file": "modeling_data/sublineage-broad-modeling-data/depmap-modeling-data_bile_duct_(cholangiocarcinoma).csv",
        "model_kwargs": {
            "lineage": "bile_duct_(cholangiocarcinoma)",
    ...
    Dimensions:                    (chain: 4, draw: 1000, delta_genes_dim_0: 5,
                                    ...
                                    delta_cells_dim_0: 2, delta_cells_dim_1: 31,
                                    cell_chrom: 713, genes_chol_cov_dim_0: 15,
                                    ...
                                    cells_chol_cov_stds_dim_0: 2, cell_line: 31)
    Coordinates: (12/19)
      ...
      * cancer_gene                (cancer_gene) object 'BRAF'
      ...
      * cell_line                  (cell_line) object 'ACH-000182' ... 'ACH-001997'
    ...
    Attributes:
        created_at:           2022-09-28 10:38:43.733155
        arviz_version:        0.12.1
        model_name:           LineageHierNegBinomModel
        model_version:        0.1.3
        model_doc:            A hierarchical negative binomial generalized linear...
        previous_created_at:  ['2022-09-28 10:38:43.733155', '2022-09-28T14:25:49...
    ...
    date created: 2022-09-28 10:38
    sampled 4 chains with (unknown) tuning steps and 1,000 draws
    num. divergences: 0, 0, 0, 0
    percent divergences: 0.0, 0.0, 0.0, 0.0
    BFMI: 0.723, 0.771, 0.823, 0.753
    avg. step size: 0.006, 0.005, 0.006, 0.005
    avg. accept prob.: 0.988, 0.99, 0.99, 0.99
...
```
    ...
    [INFO] 2022-09-28 13:00:46 [(lineage_hierarchical_nb.py:data_processing_pipeline:323] Processing data for modeling.
    [INFO] 2022-09-28 13:00:46 [(lineage_hierarchical_nb.py:data_processing_pipeline:324] LFC limits: (-5.0, 5.0)
    [WARNING] 2022-09-28 13:02:48 [(lineage_hierarchical_nb.py:data_processing_pipeline:382] number of data points dropped: 404
    [INFO] 2022-09-28 13:02:50 [(lineage_hierarchical_nb.py:target_gene_is_mutated_vector:630] number of genes mutated in all cells lines: 0
    [INFO] 2022-09-28 13:02:52 [(cancer_gene_mutation_matrix.py:_trim_cancer_genes:77] Dropping 3 cancer genes.
...
![png](hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_16_0.png)





![png](hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_16_1.png)
...
![png](hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_16_3.png)
...
![png](hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_18_0.png)
...
![png](hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_19_0.png)
...
![png](hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_22_1.png)
...
![png](hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_22_3.png)
...
![png](hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_22_5.png)
...
![png](hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_22_7.png)
...
![png](hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_22_9.png)
...
![png](hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_22_11.png)
...
![png](hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_22_13.png)
...
![png](hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_23_0.png)
...
![png](hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_23_2.png)
...
![png](hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_24_0.png)
...
![png](hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_25_0.png)
...
![png](hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_26_0.png)





![png](hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_26_1.png)
...
![png](hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_28_0.png)
...
![png](hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_30_0.png)





![png](hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_30_1.png)
...
![png](hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_32_0.png)
...
![png](hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_33_0.png)
...
![png](hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_35_0.png)
