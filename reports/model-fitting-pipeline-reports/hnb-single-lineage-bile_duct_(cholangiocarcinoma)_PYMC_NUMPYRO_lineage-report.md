...
```
    ...
    Dimensions:                    (chain: 4, draw: 1000, delta_genes_dim_0: 4,
                                    ...
                                    cell_chrom: 713, genes_chol_cov_dim_0: 10,
    ...
    Attributes:
        created_at:           2022-09-06 11:07:23.429180
        arviz_version:        0.12.1
        model_name:           LineageHierNegBinomModel
        model_version:        0.1.3
        model_doc:            A hierarchical negative binomial generalized linear...
        previous_created_at:  ['2022-09-06 11:07:23.429180', '2022-08-26T00:43:31...
    ...
    date created: 2022-09-06 11:07
    sampled 4 chains with (unknown) tuning steps and 1,000 draws
    num. divergences: 0, 0, 0, 0
    percent divergences: 0.0, 0.0, 0.0, 0.0
    BFMI: 0.701, 0.752, 0.736, 0.673
    avg. step size: 0.006, 0.006, 0.006, 0.006
    avg. accept prob.: 0.987, 0.989, 0.988, 0.988
...
```
    ...
    [INFO] 2022-09-07 15:04:07 [(lineage_hierarchical_nb.py:data_processing_pipeline:323] Processing data for modeling.
    [INFO] 2022-09-07 15:04:07 [(lineage_hierarchical_nb.py:data_processing_pipeline:324] LFC limits: (-5.0, 5.0)
    [WARNING] 2022-09-07 15:06:00 [(lineage_hierarchical_nb.py:data_processing_pipeline:382] number of data points dropped: 404
    [INFO] 2022-09-07 15:06:02 [(lineage_hierarchical_nb.py:target_gene_is_mutated_vector:630] number of genes mutated in all cells lines: 0
    [INFO] 2022-09-07 15:06:03 [(cancer_gene_mutation_matrix.py:_trim_cancer_genes:77] Dropping 2 cancer genes.
...
![png](hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-bile_duct_%28cholangiocarcinoma%29_PYMC_NUMPYRO_lineage-report_18_1.png)
