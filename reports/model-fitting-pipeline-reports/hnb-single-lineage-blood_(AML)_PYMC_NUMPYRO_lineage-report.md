...
```python
# Parameters
MODEL_NAME = "hnb-single-lineage-blood_(AML)"
...
```
    ...
    config. name: 'hnb-single-lineage-blood_(AML)'
    ...
    {
        "name": "hnb-single-lineage-blood_(AML)",
        "description": " Single lineage hierarchical negative binomial model for blood_(AML) data. ",
        "active": true,
        "model": "LINEAGE_HIERARCHICAL_NB",
        "data_file": "modeling_data/sublineage-broad-modeling-data/depmap-modeling-data_blood_(AML).csv",
        "model_kwargs": {
            "lineage": "blood_(AML)",
    ...
    Dimensions:                    (chain: 4, draw: 1000, delta_genes_dim_0: 6,
                                    ...
                                    delta_cells_dim_0: 2, delta_cells_dim_1: 25,
                                    cell_chrom: 575, genes_chol_cov_dim_0: 21,
                                    ...
                                    cells_chol_cov_stds_dim_0: 2, cell_line: 25)
    Coordinates: (12/19)
      ...
      * cancer_gene                (cancer_gene) object 'LRP1B' 'NRAS'
      ...
      * cell_line                  (cell_line) object 'ACH-000004' ... 'ACH-001656'
    ...
    Attributes:
        created_at:           2022-09-06 11:02:26.510456
        arviz_version:        0.12.1
        model_name:           LineageHierNegBinomModel
        model_version:        0.1.3
        model_doc:            A hierarchical negative binomial generalized linear...
        previous_created_at:  ['2022-09-06 11:02:26.510456', '2022-09-06T03:31:59...
    ...
    Attributes:
        created_at:           2022-09-06 11:02:26.510456
        arviz_version:        0.12.1
        previous_created_at:  ['2022-09-06 11:02:26.510456', '2022-09-06T03:32:00...
    ...
    BFMI: 0.651, 0.675, 0.713, 0.711
    avg. step size: 0.009, 0.012, 0.01, 0.01
    avg. accept prob.: 0.989, 0.985, 0.987, 0.989
    avg. tree depth: 9.0, 9.71, 9.0, 9.0
...
```
    ...
    [INFO] 2022-09-07 14:54:31 [(lineage_hierarchical_nb.py:data_processing_pipeline:323] Processing data for modeling.
    [INFO] 2022-09-07 14:54:31 [(lineage_hierarchical_nb.py:data_processing_pipeline:324] LFC limits: (-5.0, 5.0)
    [WARNING] 2022-09-07 14:56:24 [(lineage_hierarchical_nb.py:data_processing_pipeline:382] number of data points dropped: 71075
    [INFO] 2022-09-07 14:56:26 [(lineage_hierarchical_nb.py:target_gene_is_mutated_vector:630] number of genes mutated in all cells lines: 0
    [INFO] 2022-09-07 14:56:28 [(cancer_gene_mutation_matrix.py:_trim_cancer_genes:77] Dropping 20 cancer genes.
...
![png](hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_16_0.png)





![png](hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_16_1.png)
...
![png](hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_16_3.png)
...
![png](hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_18_0.png)
...
![png](hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_19_0.png)
...
![png](hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_22_1.png)
...
![png](hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_22_3.png)
...
![png](hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_22_5.png)
...
![png](hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_22_7.png)
...
![png](hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_22_9.png)
...
![png](hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_22_11.png)
...
![png](hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_22_13.png)
...
![png](hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_23_0.png)





![png](hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_23_1.png)
...
![png](hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_24_0.png)
...
![png](hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_25_0.png)
...
![png](hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_26_0.png)





![png](hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_26_1.png)
...
![png](hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_28_0.png)
...
![png](hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_30_0.png)





![png](hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_30_1.png)
...
![png](hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_31_0.png)





![png](hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_31_1.png)
...
![png](hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_32_0.png)
...
![png](hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_33_0.png)
...
![png](hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_files/hnb-single-lineage-blood_%28AML%29_PYMC_NUMPYRO_lineage-report_35_0.png)
