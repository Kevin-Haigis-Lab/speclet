...
def test_centered_copynumber_by_cellline(df: pd.DataFrame):
...
def test_centered_copynumber_by_gene(df: pd.DataFrame):
...
def test_converting_is_mutated_column(is_mutated: list[bool]):
